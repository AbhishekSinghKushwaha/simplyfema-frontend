...
class Module2Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedECBData && props.capturedECBData.topicNameDescription){
    let questions = props.capturedECBData.topicNameDescription
    this.setState({questions})
    }

    if(props.capturedECBData && props.capturedECBData.rbiReferenceLetter){
      let questions2 = props.capturedECBData.rbiReferenceLetter
      this.setState({questions2})
      }

      if(props.capturedECBData && props.capturedECBData!== this.props.capturedECBData && props.capturedECBData.sampleOthers){
        let sampleOthers = props.capturedECBData.sampleOthers
        this.setState({sampleOthers})
      }


      if(props.capturedECBData && props.capturedECBData!== this.props.capturedECBData && props.capturedECBData.sampleRbi){
        let sampleRbi = props.capturedECBData.sampleRbi
  ...
  handleChange = (e) => {
    ...
    this.props.capturedECBData.officeTeleNumber = e.target.value
  }
  ...
  handleText = i => e => {
    ...
    this.props.capturedECBData.input1 = 
    this.state.input1
  }
  ...
  addInput = e => {
    //let questions = []
    //e.preventDefault()
    // if(this.props.capturedECBData.topicNameDescription){
    //   questions = this.props.capturedECBData.topicNameDescription.concat([...this.state.questions])
    //   }
    // else{
  ...
  this.props.capturedECBData.rbiLetter = 
  ...
  addInput2 = (e) => {
    // e.preventDefault()
    // let questions2 = []
    // if(this.props.capturedECBData.rbiReferenceLetter){
    //   questions2 = this.props.capturedECBData.rbiReferenceLetter.concat([...this.state.questions2])
    //   }
    // else{
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedECBData.hasOwnProperty('natureContravention')
                        ? this.props.capturedECBData.natureContravention
                        : this.state.natureOfContravention
                    }
                    onChange={e => {
                      this.setState({ natureOfContravention: e.target.value})
                      this.props.capturedECBData.natureOfContravention =
                      e.target.value
                    }}
                    required
                  />
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectFema
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectRegulationNo
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='input1'>Others - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedECBData &&
          this.props.capturedECBData.hasOwnProperty('topicNameDescription')
            ? this.props.capturedECBData.topicNameDescription[index]
                  ...
                  <Checkbox
                    ...
                    onChange = {checkedValue => {
                      this.setState(prevState => {
                       ...
                       this.props.capturedECBData.sampleOthers =
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectCAAoption
                          : CAAOptions[0].label,
                      value:
                        this.props.capturedECBData &&
                        this.props.capturedECBData.hasOwnProperty(
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectcentralOptions
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('subjectCompounding')
                        ? this.props.capturedECBData.subjectCompounding
                        : this.state.subjectOfCompounding
                    }
                    onChange={e => {
                      this.setState({ subjectOfCompounding: e.target.value})
                      this.props.capturedECBData.subjectOfCompounding =
                      e.target.value
                    }}
                    required
                  />
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    checked={this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('sample_subjectOfCompounding_1')
                        ? this.props.capturedECBData.sample_subjectOfCompounding_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('sample_subjectOfCompounding_2')
                        ? this.props.capturedECBData.sample_subjectOfCompounding_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('sample_subjectOfCompounding_3')
                        ? this.props.capturedECBData.sample_subjectOfCompounding_3
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>RBI Reference Letter - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedECBData &&
          this.props.capturedECBData.hasOwnProperty('rbiReferenceLetter')
            ? this.props.capturedECBData.rbiReferenceLetter[index]
            : this.state.rbiLetter[index]
        }
        //value={question}
        // onChange={e => {
        //   this.setState({ rbiReferenceLetter: e.target.value})
        //   this.props.capturedECBData.rbiReferenceLetter =
        //   e.target.value
        // }}
        required
      />
                  ...
                  <Checkbox
                   ...
                   onChange = {checkedValue => {
                     ...
                     this.setState(prevState => {
                      ...
                      this.props.capturedECBData.sampleRbi =
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('residentoutsideIndia')
                        ? this.props.capturedECBData.residentoutsideIndia
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('sample_indiaOrNot_1')
                        ? this.props.capturedECBData.sample_indiaOrNot_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('sample_indiaOrNot_2')
                        ? this.props.capturedECBData.sample_indiaOrNot_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('sample_indiaOrNot_3')
                        ? this.props.capturedECBData.sample_indiaOrNot_3
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('nameAdjudicatingAuthority')
                        ? this.props.capturedECBData.nameAdjudicatingAuthority
                        : this.state.nameOfAdjudicatingAuthority
                    }
                    onChange={e => {
                      this.setState({ nameOfAdjudicatingAuthority: e.target.value})
                      this.props.capturedECBData.nameOfAdjudicatingAuthority =
                      e.target.value
                    }}
                    required
                  />
        ...
        <div style={{width:'25%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('compoundingApplicationfee')
                        ? this.props.capturedECBData.compoundingApplicationfee
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedECBData &&
                    //   this.props.capturedECBData.hasOwnProperty('dateIncorporationmod2')
                    //     ? new Date(this.props.capturedECBData.dateIncorporationmod2)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      ...
                      this.props.capturedECBData.dateIncorporationmod2 = new Date(
        ...
        <div style={{width:'26%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('officeTeleNo')
                        ? this.props.capturedECBData.officeTeleNo
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectpayOption
                          : PayOptions[0].label,
                      value:
                        this.props.capturedECBData &&
                        this.props.capturedECBData.hasOwnProperty(
