...
class Module1Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedECBData.officeFaxNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedECBData.hasOwnProperty('legalNameBusiness')
                        ? this.props.capturedECBData.legalNameBusiness
                        : this.state.legalNameOfBusiness
                    }
                    onChange={e => {
                      this.setState({ legalNameOfBusiness: e.target.value})
                      this.props.capturedECBData.legalNameOfBusiness =
                      e.target.value
                    }}
                    required
                    />
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={ 
                    //   this.props.capturedECBData &&
                    //   this.props.capturedECBData.hasOwnProperty('dateIncorporation')
                    //     ? new Date(this.props.capturedECBData.dateIncorporation)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      this.setState({dateOfIncorporation:enteredDate})
                      this.props.capturedECBData.dateIncorporation = new Date(
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('cinNumber')
                        ? this.props.capturedECBData.cinNumber
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectnicOption
                          : NicOptions[0].label,
                      value:
                        this.props.capturedECBData &&
                        this.props.capturedECBData.hasOwnProperty(
                    ...
                    onChange={
                      ...
                      this.props.capturedECBData.selectnicOption = selectNicOption.label
                    }}
                    required
                    />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('mainactivities')
                        ? this.props.capturedECBData.mainactivities
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('additionalactivities')
                        ? this.props.capturedECBData.additionalactivities
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedECBData.hasOwnProperty(
                          ...
                          ? this.props.capturedECBData.selectactivityOption
                    ...
                    onChange={selectActivityOption => {
                      ...
                      this.props.capturedECBData.selectactivityOption = selectActivityOption.label
                    }}
                    required
                    />
                  <AvFeedback>
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('buildingNo')
                        ? this.props.capturedECBData.buildingNo
                        : this.state.buildingNumber
                    }
                    onChange={e => {
                      this.setState({ buildingNumber: e.target.value})
                      this.props.capturedECBData.buildingNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('floorNo')
                        ? this.props.capturedECBData.floorNo
                        : this.state.floorNumber
                    }
                    onChange={e => {
                      this.setState({ floorNumber: e.target.value})
                      this.props.capturedECBData.floorNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('nameThePremisesOrBuilding')
                        ? this.props.capturedECBData.nameThePremisesOrBuilding
                        : this.state.nameOfThePremisesOrBuilding
                    }
                    onChange={e => {
                      this.setState({ nameOfThePremisesOrBuilding: e.target.value})
                      this.props.capturedECBData.nameOfThePremisesOrBuilding =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('Street')
                        ? this.props.capturedECBData.Street
                        : this.state.roadOrStreet
                    }
                    onChange={e => {
                      this.setState({ roadOrStreet: e.target.value})
                      this.props.capturedECBData.roadOrStreet =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('Area')
                        ? this.props.capturedECBData.Area
                        : this.state.area
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('City')
                        ? this.props.capturedECBData.City
                        : this.state.cityOrTownOrLocalityOrVillage
                    }
                    onChange={e => {
                      this.setState({ cityOrTownOrLocalityOrVillage: e.target.value})
                      this.props.capturedECBData.cityOrTownOrLocalityOrVillage =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('State')
                        ? this.props.capturedECBData.State
                        : this.state.state
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('Country')
                        ? this.props.capturedECBData.Country
                        : this.state.country
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('Pincode')
                        ? this.props.capturedECBData.Pincode
                        : this.state.pincode
                    }
                    onChange={e => {
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('officeemailAddress')
                        ? this.props.capturedECBData.officeemailAddress
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('mobileNo')
                        ? this.props.capturedECBData.mobileNo
                        : this.state.mobileNumber
                    }
                    onChange={e => {
                      this.setState({ mobileNumber: e.target.value})
                      this.props.capturedECBData.mobileNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('officeTelephoneNo')
                        ? this.props.capturedECBData.officeTelephoneNo
                        : this.state.officeTelephoneNumber
                    }
                    onChange={e => {
                      this.setState({ officeTelephoneNumber: e.target.value})
                      this.props.capturedECBData.officeTelephoneNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedECBData &&
                      this.props.capturedECBData.hasOwnProperty('officeFaxNo')
                        ? this.props.capturedECBData.officeFaxNo
