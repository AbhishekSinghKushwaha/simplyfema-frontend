...
class Module3Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedECBData && props.capturedECBData.background_input){
      let questions1 = props.capturedECBData.background_input
      this.setState({questions1})
      }

    if(props.capturedECBData && props.capturedECBData.natureofcontraventions_input){
      let questions2 = props.capturedECBData.natureofcontraventions_input
      this.setState({questions2})
      }

    if(props.capturedECBData && props.capturedECBData.delayreasons_input){
      let questions3 = props.capturedECBData.delayreasons_input
      this.setState({questions3})
      }
    
    if(props.capturedECBData && props.capturedECBData.petitionrequest_input){
      let questions4 = props.capturedECBData.petitionrequest_input
      this.setState({questions4})
      }

    if(props.capturedECBData && props.capturedECBData!== this.props.capturedECBData && props.capturedECBData.sample1){
        let sample1 = props.capturedECBData.sample1
        this.setState({sample1})
      }  

    if(props.capturedECBData && props.capturedECBData!== this.props.capturedECBData && props.capturedECBData.sample2){
        let sample2 = props.capturedECBData.sample2
        this.setState({sample2})
      } 

    if(props.capturedECBData && props.capturedECBData!== this.props.capturedECBData && props.capturedECBData.sample3){
        let sample3 = props.capturedECBData.sample3
        this.setState({sample3})
      }
      
      if(props.capturedECBData && props.capturedECBData!== this.props.capturedECBData && props.capturedECBData.sample4){
        let sample4 = props.capturedECBData.sample4
  ...
  handleText = (i, id) => e=> {
    ...
    if (id === 1) {
      ...
      this.props.capturedECBData.background = this.state.background;
    }
    if (id === 2) {
      let questions2 = [...this.state.questions2];
      questions2[i] = e.target.value;

      this.props.capturedECBData.natureofcontraventions =
    ...
    if (id === 3) {
      ...
      this.props.capturedECBData.delayreasons =
    ...
    if (id === 4) {
      ...
      this.props.capturedECBData.petitionrequest =
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedECBData.sample1 =
                                                              this.state.sample1
                                                        }}
                                                      />
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedECBData.sample2 =
                                                              this.state.sample2
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedECBData.sample3 =
                                                              this.state.sample3
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedECBData.sample4 =
                                                              this.state.sample4
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
...
//     this.props.capturedECBData.background1_input_1 =
//     this.state.background1_input_1
//     this.props.capturedECBData.background1_input_2 =
//     this.state.background1_input_2
//     this.props.capturedECBData.background1_input_3 =
//     this.state.background1_input_3
//     this.props.capturedECBData.background1_input_4 =
//     this.state.background1_input_4
//     this.props.capturedECBData.background1_input_5 =
//     this.state.background1_input_5
//     this.props.capturedECBData.background1_input_6 =
//     this.state.background1_input_6
//     this.props.capturedECBData.background1_input_7 =
//     this.state.background1_input_7
//     this.props.capturedECBData.background1_input_8 =
//     this.state.background1_input_8
//     this.props.capturedECBData.background1_input_9 =
//     this.state.background1_input_9
//     this.props.capturedECBData.background1_input_10 =
//     this.state.background1_input_10
//     this.props.capturedECBData.background1_input_11=
...
//     this.props.capturedECBData.background2_input_1 =
//     this.state.background2_input_1
//     this.props.capturedECBData.background2_input_2 =
//     this.state.background2_input_2
//     this.props.capturedECBData.background2_input_3 =
//     this.state.background2_input_3
//     this.props.capturedECBData.background2_input_4 =
//     this.state.background2_input_4
//     this.props.capturedECBData.background2_input_5 =
//     this.state.background2_input_5
//     this.props.capturedECBData.background2_input_6 =
//     this.state.background2_input_6
//     this.props.capturedECBData.background2_input_7 =
//     this.state.background2_input_7
//     this.props.capturedECBData.background2_input_8 =
//     this.state.background2_input_8
//     this.props.capturedECBData.background2_input_9 =
//     this.state.background2_input_9
//     this.props.capturedECBData.background2_input_10 =
//     this.state.background2_input_10
//     this.props.capturedECBData.background2_input_11=
...
//     this.props.capturedECBData.background3_input_1 =
//     this.state.background3_input_1
//     this.props.capturedECBData.background3_input_2 =
//     this.state.background3_input_2
//     this.props.capturedECBData.background3_input_3 =
//     this.state.background3_input_3
//     this.props.capturedECBData.background3_input_4 =
//     this.state.background3_input_4
//     this.props.capturedECBData.background3_input_5 =
//     this.state.background3_input_5
//     this.props.capturedECBData.background3_input_6 =
//     this.state.background3_input_6
//     this.props.capturedECBData.background3_input_7 =
//     this.state.background3_input_7
//     this.props.capturedECBData.background3_input_8 =
//     this.state.background3_input_8
//     this.props.capturedECBData.background3_input_9 =
//     this.state.background3_input_9
//     this.props.capturedECBData.background3_input_10 =
//     this.state.background3_input_10
//     this.props.capturedECBData.background3_input_11=
...
//     this.props.capturedECBData.background4_input_1 =
//     this.state.background4_input_1
//     this.props.capturedECBData.background4_input_2 =
//     this.state.background4_input_2
//     this.props.capturedECBData.background4_input_3 =
//     this.state.background4_input_3
//     this.props.capturedECBData.background4_input_4 =
//     this.state.background4_input_4
//     this.props.capturedECBData.background4_input_5 =
//     this.state.background4_input_5
//     this.props.capturedECBData.background4_input_6 =
//     this.state.background4_input_6
//     this.props.capturedECBData.background4_input_7 =
//     this.state.background4_input_7
//     this.props.capturedECBData.background4_input_8 =
//     this.state.background4_input_8
//     this.props.capturedECBData.background4_input_9 =
//     this.state.background4_input_9
//     this.props.capturedECBData.background4_input_10 =
//     this.state.background4_input_10
//     this.props.capturedECBData.background4_input_11=
...
//                         this.props.capturedECBData.sample1_1 =
...
//                         this.props.capturedECBData.sample1_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample1_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample2_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample2_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample2_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample3_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample3_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample3_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample4_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample4_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedECBData.sample4_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
