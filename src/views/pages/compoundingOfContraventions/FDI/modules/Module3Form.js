...
class Module3Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedFDIData && props.capturedFDIData.background_input){
      let questions1 = props.capturedFDIData.background_input
      this.setState({questions1})
      }

    if(props.capturedFDIData && props.capturedFDIData.natureofcontraventions_input){
      let questions2 = props.capturedFDIData.natureofcontraventions_input
      this.setState({questions2})
      }

    if(props.capturedFDIData && props.capturedFDIData.delayreasons_input){
      let questions3 = props.capturedFDIData.delayreasons_input
      this.setState({questions3})
      }
    
    if(props.capturedFDIData && props.capturedFDIData.petitionrequest_input){
      let questions4 = props.capturedFDIData.petitionrequest_input
      this.setState({questions4})
      }

    if(props.capturedFDIData && props.capturedFDIData!== this.props.capturedFDIData && props.capturedFDIData.sample1){
        let sample1 = props.capturedFDIData.sample1
        this.setState({sample1})
      }  

    if(props.capturedFDIData && props.capturedFDIData!== this.props.capturedFDIData && props.capturedFDIData.sample2){
        let sample2 = props.capturedFDIData.sample2
        this.setState({sample2})
      } 

    if(props.capturedFDIData && props.capturedFDIData!== this.props.capturedFDIData && props.capturedFDIData.sample3){
        let sample3 = props.capturedFDIData.sample3
        this.setState({sample3})
      }
      
      if(props.capturedFDIData && props.capturedFDIData!== this.props.capturedFDIData && props.capturedFDIData.sample4){
        let sample4 = props.capturedFDIData.sample4
  ...
  handleText = (i, id) => e=> {
    ...
    if (id === 1) {
      ...
      this.props.capturedFDIData.background = this.state.background;
    }
    if (id === 2) {
      let questions2 = [...this.state.questions2];
      questions2[i] = e.target.value;

      this.props.capturedFDIData.natureofcontraventions =
    ...
    if (id === 3) {
      ...
      this.props.capturedFDIData.delayreasons =
    ...
    if (id === 4) {
      ...
      this.props.capturedFDIData.petitionrequest =
                              ...
                              >
                                <Input
                                  ...
                                  value={
                                    ...
                                    this.props.capturedFDIData.hasOwnProperty(
                                      "background_input"
                                    )
                                      ? this.props.capturedFDIData
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedFDIData.sample1 =
                                                              this.state.sample1
                                                        }}
                                                      />
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedFDIData.sample2 =
                                                              this.state.sample2
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedFDIData.sample3 =
                                                              this.state.sample3
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedFDIData.sample4 =
                                                              this.state.sample4
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
...
//     this.props.capturedFDIData.background1_input_1 =
//     this.state.background1_input_1
//     this.props.capturedFDIData.background1_input_2 =
//     this.state.background1_input_2
//     this.props.capturedFDIData.background1_input_3 =
//     this.state.background1_input_3
//     this.props.capturedFDIData.background1_input_4 =
//     this.state.background1_input_4
//     this.props.capturedFDIData.background1_input_5 =
//     this.state.background1_input_5
//     this.props.capturedFDIData.background1_input_6 =
//     this.state.background1_input_6
//     this.props.capturedFDIData.background1_input_7 =
//     this.state.background1_input_7
//     this.props.capturedFDIData.background1_input_8 =
//     this.state.background1_input_8
//     this.props.capturedFDIData.background1_input_9 =
//     this.state.background1_input_9
//     this.props.capturedFDIData.background1_input_10 =
//     this.state.background1_input_10
//     this.props.capturedFDIData.background1_input_11=
...
//     this.props.capturedFDIData.background2_input_1 =
//     this.state.background2_input_1
//     this.props.capturedFDIData.background2_input_2 =
//     this.state.background2_input_2
//     this.props.capturedFDIData.background2_input_3 =
//     this.state.background2_input_3
//     this.props.capturedFDIData.background2_input_4 =
//     this.state.background2_input_4
//     this.props.capturedFDIData.background2_input_5 =
//     this.state.background2_input_5
//     this.props.capturedFDIData.background2_input_6 =
//     this.state.background2_input_6
//     this.props.capturedFDIData.background2_input_7 =
//     this.state.background2_input_7
//     this.props.capturedFDIData.background2_input_8 =
//     this.state.background2_input_8
//     this.props.capturedFDIData.background2_input_9 =
//     this.state.background2_input_9
//     this.props.capturedFDIData.background2_input_10 =
//     this.state.background2_input_10
//     this.props.capturedFDIData.background2_input_11=
...
//     this.props.capturedFDIData.background3_input_1 =
//     this.state.background3_input_1
//     this.props.capturedFDIData.background3_input_2 =
//     this.state.background3_input_2
//     this.props.capturedFDIData.background3_input_3 =
//     this.state.background3_input_3
//     this.props.capturedFDIData.background3_input_4 =
//     this.state.background3_input_4
//     this.props.capturedFDIData.background3_input_5 =
//     this.state.background3_input_5
//     this.props.capturedFDIData.background3_input_6 =
//     this.state.background3_input_6
//     this.props.capturedFDIData.background3_input_7 =
//     this.state.background3_input_7
//     this.props.capturedFDIData.background3_input_8 =
//     this.state.background3_input_8
//     this.props.capturedFDIData.background3_input_9 =
//     this.state.background3_input_9
//     this.props.capturedFDIData.background3_input_10 =
//     this.state.background3_input_10
//     this.props.capturedFDIData.background3_input_11=
...
//     this.props.capturedFDIData.background4_input_1 =
//     this.state.background4_input_1
//     this.props.capturedFDIData.background4_input_2 =
//     this.state.background4_input_2
//     this.props.capturedFDIData.background4_input_3 =
//     this.state.background4_input_3
//     this.props.capturedFDIData.background4_input_4 =
//     this.state.background4_input_4
//     this.props.capturedFDIData.background4_input_5 =
//     this.state.background4_input_5
//     this.props.capturedFDIData.background4_input_6 =
//     this.state.background4_input_6
//     this.props.capturedFDIData.background4_input_7 =
//     this.state.background4_input_7
//     this.props.capturedFDIData.background4_input_8 =
//     this.state.background4_input_8
//     this.props.capturedFDIData.background4_input_9 =
//     this.state.background4_input_9
//     this.props.capturedFDIData.background4_input_10 =
//     this.state.background4_input_10
//     this.props.capturedFDIData.background4_input_11=
...
//                         this.props.capturedFDIData.sample1_1 =
...
//                         this.props.capturedFDIData.sample1_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample1_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample2_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample2_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample2_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample3_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample3_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample3_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample4_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample4_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedFDIData.sample4_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
