...
class Module2Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedFDIData && props.capturedFDIData.topicNameDescription){
    let questions = props.capturedFDIData.topicNameDescription
    this.setState({questions})
    }

    if(props.capturedFDIData && props.capturedFDIData.rbiReferenceLetter){
      let questions2 = props.capturedFDIData.rbiReferenceLetter
      this.setState({questions2})
      }

      if(props.capturedFDIData && props.capturedFDIData!== this.props.capturedFDIData && props.capturedFDIData.sampleOthers){
        let sampleOthers = props.capturedFDIData.sampleOthers
        this.setState({sampleOthers})
      }


      if(props.capturedFDIData && props.capturedFDIData!== this.props.capturedFDIData && props.capturedFDIData.sampleRbi){
        let sampleRbi = props.capturedFDIData.sampleRbi
  ...
  handleChange = (e) => {
    ...
    this.props.capturedFDIData.officeTeleNumber = e.target.value
  }
  ...
  handleText = i => e => {
    ...
    this.props.capturedFDIData.input1 = 
    this.state.input1
  }
  ...
  addInput = e => {
    //let questions = []
    //e.preventDefault()
    // if(this.props.capturedFDIData.topicNameDescription){
    //   questions = this.props.capturedFDIData.topicNameDescription.concat([...this.state.questions])
    //   }
    // else{
  ...
  this.props.capturedFDIData.rbiLetter = 
  ...
  addInput2 = (e) => {
    // e.preventDefault()
    // let questions2 = []
    // if(this.props.capturedFDIData.rbiReferenceLetter){
    //   questions2 = this.props.capturedFDIData.rbiReferenceLetter.concat([...this.state.questions2])
    //   }
    // else{
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedFDIData.hasOwnProperty('natureContravention')
                        ? this.props.capturedFDIData.natureContravention
                        : this.state.natureOfContravention
                    }
                    onChange={e => {
                      this.setState({ natureOfContravention: e.target.value})
                      this.props.capturedFDIData.natureOfContravention =
                      e.target.value
                    }}
                    required
                  />
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectFema
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectRegulationNo
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='input1'>Others - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedFDIData &&
          this.props.capturedFDIData.hasOwnProperty('topicNameDescription')
            ? this.props.capturedFDIData.topicNameDescription[index]
                  ...
                  <Checkbox
                    ...
                    onChange = {checkedValue => {
                      this.setState(prevState => {
                       ...
                       this.props.capturedFDIData.sampleOthers =
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectCAAoption
                          : CAAOptions[0].label,
                      value:
                        this.props.capturedFDIData &&
                        this.props.capturedFDIData.hasOwnProperty(
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectcentralOptions
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('subjectCompounding')
                        ? this.props.capturedFDIData.subjectCompounding
                        : this.state.subjectOfCompounding
                    }
                    onChange={e => {
                      this.setState({ subjectOfCompounding: e.target.value})
                      this.props.capturedFDIData.subjectOfCompounding =
                      e.target.value
                    }}
                    required
                  />
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    icon={<Check className='vx-icon' size={16} />}
                    label=''
                    checked={this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('sample_subjectOfCompounding_1')
                        ? this.props.capturedFDIData.sample_subjectOfCompounding_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('sample_subjectOfCompounding_2')
                        ? this.props.capturedFDIData.sample_subjectOfCompounding_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('sample_subjectOfCompounding_3')
                        ? this.props.capturedFDIData.sample_subjectOfCompounding_3
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>RBI Reference Letter - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedFDIData &&
          this.props.capturedFDIData.hasOwnProperty('rbiReferenceLetter')
            ? this.props.capturedFDIData.rbiReferenceLetter[index]
            : this.state.rbiLetter[index]
        }
        //value={question}
        // onChange={e => {
        //   this.setState({ rbiReferenceLetter: e.target.value})
        //   this.props.capturedFDIData.rbiReferenceLetter =
        //   e.target.value
        // }}
        required
      />
                  ...
                  <Checkbox
                   ...
                   onChange = {checkedValue => {
                     ...
                     this.setState(prevState => {
                      ...
                      this.props.capturedFDIData.sampleRbi =
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('residentoutsideIndia')
                        ? this.props.capturedFDIData.residentoutsideIndia
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('sample_indiaOrNot_1')
                        ? this.props.capturedFDIData.sample_indiaOrNot_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('sample_indiaOrNot_2')
                        ? this.props.capturedFDIData.sample_indiaOrNot_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('sample_indiaOrNot_3')
                        ? this.props.capturedFDIData.sample_indiaOrNot_3
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('nameAdjudicatingAuthority')
                        ? this.props.capturedFDIData.nameAdjudicatingAuthority
                        : this.state.nameOfAdjudicatingAuthority
                    }
                    onChange={e => {
                      this.setState({ nameOfAdjudicatingAuthority: e.target.value})
                      this.props.capturedFDIData.nameOfAdjudicatingAuthority =
                      e.target.value
                    }}
                    required
                  />
        ...
        <div style={{width:'25%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('compoundingApplicationfee')
                        ? this.props.capturedFDIData.compoundingApplicationfee
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedFDIData &&
                    //   this.props.capturedFDIData.hasOwnProperty('dateIncorporationmod2')
                    //     ? new Date(this.props.capturedFDIData.dateIncorporationmod2)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      ...
                      this.props.capturedFDIData.dateIncorporationmod2 = new Date(
        ...
        <div style={{width:'26%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('officeTeleNo')
                        ? this.props.capturedFDIData.officeTeleNo
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectpayOption
                          : PayOptions[0].label,
                      value:
                        this.props.capturedFDIData &&
                        this.props.capturedFDIData.hasOwnProperty(
