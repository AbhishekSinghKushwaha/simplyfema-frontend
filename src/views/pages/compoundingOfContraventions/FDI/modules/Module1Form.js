...
class Module1Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedFDIData.officeFaxNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedFDIData.hasOwnProperty('legalNameBusiness')
                        ? this.props.capturedFDIData.legalNameBusiness
                        : this.state.legalNameOfBusiness
                    }
                    onChange={e => {
                      this.setState({ legalNameOfBusiness: e.target.value})
                      this.props.capturedFDIData.legalNameOfBusiness =
                      e.target.value
                    }}
                    required
                    />
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={ 
                    //   this.props.capturedFDIData &&
                    //   this.props.capturedFDIData.hasOwnProperty('dateIncorporation')
                    //     ? new Date(this.props.capturedFDIData.dateIncorporation)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      this.setState({dateOfIncorporation:enteredDate})
                      this.props.capturedFDIData.dateIncorporation = new Date(
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('cinNumber')
                        ? this.props.capturedFDIData.cinNumber
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectnicOption
                          : NicOptions[0].label,
                      value:
                        this.props.capturedFDIData &&
                        this.props.capturedFDIData.hasOwnProperty(
                    ...
                    onChange={
                      ...
                      this.props.capturedFDIData.selectnicOption = selectNicOption.label
                    }}
                    required
                    />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('mainactivities')
                        ? this.props.capturedFDIData.mainactivities
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('additionalactivities')
                        ? this.props.capturedFDIData.additionalactivities
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedFDIData.hasOwnProperty(
                          ...
                          ? this.props.capturedFDIData.selectactivityOption
                    ...
                    onChange={selectActivityOption => {
                      ...
                      this.props.capturedFDIData.selectactivityOption = selectActivityOption.label
                    }}
                    required
                    />
                  <AvFeedback>
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('buildingNo')
                        ? this.props.capturedFDIData.buildingNo
                        : this.state.buildingNumber
                    }
                    onChange={e => {
                      this.setState({ buildingNumber: e.target.value})
                      this.props.capturedFDIData.buildingNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('floorNo')
                        ? this.props.capturedFDIData.floorNo
                        : this.state.floorNumber
                    }
                    onChange={e => {
                      this.setState({ floorNumber: e.target.value})
                      this.props.capturedFDIData.floorNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('nameThePremisesOrBuilding')
                        ? this.props.capturedFDIData.nameThePremisesOrBuilding
                        : this.state.nameOfThePremisesOrBuilding
                    }
                    onChange={e => {
                      this.setState({ nameOfThePremisesOrBuilding: e.target.value})
                      this.props.capturedFDIData.nameOfThePremisesOrBuilding =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('Street')
                        ? this.props.capturedFDIData.Street
                        : this.state.roadOrStreet
                    }
                    onChange={e => {
                      this.setState({ roadOrStreet: e.target.value})
                      this.props.capturedFDIData.roadOrStreet =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('Area')
                        ? this.props.capturedFDIData.Area
                        : this.state.area
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('City')
                        ? this.props.capturedFDIData.City
                        : this.state.cityOrTownOrLocalityOrVillage
                    }
                    onChange={e => {
                      this.setState({ cityOrTownOrLocalityOrVillage: e.target.value})
                      this.props.capturedFDIData.cityOrTownOrLocalityOrVillage =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('State')
                        ? this.props.capturedFDIData.State
                        : this.state.state
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('Country')
                        ? this.props.capturedFDIData.Country
                        : this.state.country
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('Pincode')
                        ? this.props.capturedFDIData.Pincode
                        : this.state.pincode
                    }
                    onChange={e => {
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('officeemailAddress')
                        ? this.props.capturedFDIData.officeemailAddress
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('mobileNo')
                        ? this.props.capturedFDIData.mobileNo
                        : this.state.mobileNumber
                    }
                    onChange={e => {
                      this.setState({ mobileNumber: e.target.value})
                      this.props.capturedFDIData.mobileNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('officeTelephoneNo')
                        ? this.props.capturedFDIData.officeTelephoneNo
                        : this.state.officeTelephoneNumber
                    }
                    onChange={e => {
                      this.setState({ officeTelephoneNumber: e.target.value})
                      this.props.capturedFDIData.officeTelephoneNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedFDIData &&
                      this.props.capturedFDIData.hasOwnProperty('officeFaxNo')
                        ? this.props.capturedFDIData.officeFaxNo
