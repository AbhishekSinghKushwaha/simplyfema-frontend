...
class VuexyWizard extends React.Component {
  ...
  state = {
    ...
    errors: [],
    values: [],
    fetchedFdiData: this.props.values ? this.props.values.fdiValues : {},
  ...
  render () {
    ...
    const params = {
      ...
      <div  className={"swiper-button-prev lala"}></div>,
      
      renderNextButton: () => <div  className="swiper-button-next lala"></div>,
          ...
          {this.props.steps.map((item, i) => {
            return (
              ...
              >
                ...
                {item.stepNumber && item.stepNumber === 5  && <div style={{marginTop:'50px'}}></div> }                
                {item.stepNumber && item.stepNumber === 4   && <div style={{marginTop:'50px'}}></div> }                
                {item.stepNumber && item.stepNumber === 7  && <div style={{marginTop:'50px'}}></div> }                
                {/* {!item.stepNumber && <div style={{marginTop:'50px'}}></div> } */}
              ...
              >
                <FormTag
                  ...
                  onSubmit={(e, errors, values) => {
                    ...
                    // var tempData = Object.assign(values, this.state.fetchedFdiData )
                    var tempData = Object.assign(
                      values,
                      this.props.capturedFDIData
                    )
                    Object.create(tempData)
                    this.setState({ fetchedFdiData: tempData })
                    //console.log(this.state.fetchedFdiData, "fetchedFdiData")
                    this.props.nextData(this.state.fetchedFdiData)
                ...
                >
                  ...
                  {this.props.pagination ? (
                    <div className='wizard-actions d-flex justify-content-between'>
                      ...
                      <Button type='submit' color='primary' onClick = {this.props.steps.length - 1 === i &&!this.props.finishBtnText&&this.props.update}>
...
VuexyWizard.propTypes = {
  ...
  capturedFDIData: PropTypes.object
}
