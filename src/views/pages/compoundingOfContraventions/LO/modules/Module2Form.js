...
class Module2Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedLOData && props.capturedLOData.topicNameDescription){
    let questions = props.capturedLOData.topicNameDescription
    this.setState({questions})
    }

    if(props.capturedLOData && props.capturedLOData.rbiReferenceLetter){
      let questions2 = props.capturedLOData.rbiReferenceLetter
      this.setState({questions2})
      }

      if(props.capturedLOData && props.capturedLOData!== this.props.capturedLOData && props.capturedLOData.sampleOthers){
        let sampleOthers = props.capturedLOData.sampleOthers
        this.setState({sampleOthers})
      }


      if(props.capturedLOData && props.capturedLOData!== this.props.capturedLOData && props.capturedLOData.sampleRbi){
        let sampleRbi = props.capturedLOData.sampleRbi
  ...
  handleChange = (e) => {
    ...
    this.props.capturedLOData.officeTeleNumber = e.target.value
  }
  ...
  handleText = i => e => {
    ...
    this.props.capturedLOData.input1 = 
    this.state.input1
  }
  ...
  addInput = e => {
    //let questions = []
    //e.preventDefault()
    // if(this.props.capturedLOData.topicNameDescription){
    //   questions = this.props.capturedLOData.topicNameDescription.concat([...this.state.questions])
    //   }
    // else{
  ...
  this.props.capturedLOData.rbiLetter = 
  ...
  addInput2 = (e) => {
    // e.preventDefault()
    // let questions2 = []
    // if(this.props.capturedLOData.rbiReferenceLetter){
    //   questions2 = this.props.capturedLOData.rbiReferenceLetter.concat([...this.state.questions2])
    //   }
    // else{
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedLOData.hasOwnProperty('natureContravention')
                        ? this.props.capturedLOData.natureContravention
                        : this.state.natureOfContravention
                    }
                    onChange={e => {
                      this.setState({ natureOfContravention: e.target.value})
                      this.props.capturedLOData.natureOfContravention =
                      e.target.value
                    }}
                    required
                  />
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedLOData.hasOwnProperty(
                          ...
                          ? this.props.capturedLOData.selectFema
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedLOData.hasOwnProperty(
                          ...
                          ? this.props.capturedLOData.selectRegulationNo
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='input1'>Others - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedLOData &&
          this.props.capturedLOData.hasOwnProperty('topicNameDescription')
            ? this.props.capturedLOData.topicNameDescription[index]
                  ...
                  <Checkbox
                    ...
                    onChange = {checkedValue => {
                      this.setState(prevState => {
                       ...
                       this.props.capturedLOData.sampleOthers =
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedLOData.hasOwnProperty(
                          ...
                          ? this.props.capturedLOData.selectCAAoption
                          : CAAOptions[0].label,
                      value:
                        this.props.capturedLOData &&
                        this.props.capturedLOData.hasOwnProperty(
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedLOData.hasOwnProperty(
                          ...
                          ? this.props.capturedLOData.selectcentralOptions
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('subjectCompounding')
                        ? this.props.capturedLOData.subjectCompounding
                        : this.state.subjectOfCompounding
                    }
                    onChange={e => {
                      this.setState({ subjectOfCompounding: e.target.value})
                      this.props.capturedLOData.subjectOfCompounding =
                      e.target.value
                    }}
                    required
                  />
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    icon={<Check className='vx-icon' size={16} />}
                    label=''
                    checked={this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('sample_subjectOfCompounding_1')
                        ? this.props.capturedLOData.sample_subjectOfCompounding_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('sample_subjectOfCompounding_2')
                        ? this.props.capturedLOData.sample_subjectOfCompounding_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('sample_subjectOfCompounding_3')
                        ? this.props.capturedLOData.sample_subjectOfCompounding_3
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>RBI Reference Letter - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedLOData &&
          this.props.capturedLOData.hasOwnProperty('rbiReferenceLetter')
            ? this.props.capturedLOData.rbiReferenceLetter[index]
            : this.state.rbiLetter[index]
        }
        //value={question}
        // onChange={e => {
        //   this.setState({ rbiReferenceLetter: e.target.value})
        //   this.props.capturedLOData.rbiReferenceLetter =
        //   e.target.value
        // }}
        required
      />
                  ...
                  <Checkbox
                   ...
                   onChange = {checkedValue => {
                     ...
                     this.setState(prevState => {
                      ...
                      this.props.capturedLOData.sampleRbi =
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('residentoutsideIndia')
                        ? this.props.capturedLOData.residentoutsideIndia
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('sample_indiaOrNot_1')
                        ? this.props.capturedLOData.sample_indiaOrNot_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('sample_indiaOrNot_2')
                        ? this.props.capturedLOData.sample_indiaOrNot_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('sample_indiaOrNot_3')
                        ? this.props.capturedLOData.sample_indiaOrNot_3
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('nameAdjudicatingAuthority')
                        ? this.props.capturedLOData.nameAdjudicatingAuthority
                        : this.state.nameOfAdjudicatingAuthority
                    }
                    onChange={e => {
                      this.setState({ nameOfAdjudicatingAuthority: e.target.value})
                      this.props.capturedLOData.nameOfAdjudicatingAuthority =
                      e.target.value
                    }}
                    required
                  />
        ...
        <div style={{width:'25%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('compoundingApplicationfee')
                        ? this.props.capturedLOData.compoundingApplicationfee
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedLOData &&
                    //   this.props.capturedLOData.hasOwnProperty('dateIncorporationmod2')
                    //     ? new Date(this.props.capturedLOData.dateIncorporationmod2)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      ...
                      this.props.capturedLOData.dateIncorporationmod2 = new Date(
        ...
        <div style={{width:'26%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('officeTeleNo')
                        ? this.props.capturedLOData.officeTeleNo
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedLOData.hasOwnProperty(
                          ...
                          ? this.props.capturedLOData.selectpayOption
                          : PayOptions[0].label,
                      value:
                        this.props.capturedLOData &&
                        this.props.capturedLOData.hasOwnProperty(
