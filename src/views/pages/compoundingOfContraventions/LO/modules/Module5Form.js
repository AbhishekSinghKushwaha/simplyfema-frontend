...
class Module5Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedLOData.panNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedLOData.hasOwnProperty('nameOfPerson')
                        ? this.props.capturedLOData.nameOfPerson
                        : this.state.nameOfThePerson
                    }
                    onChange={e => {
                      this.setState({ nameOfThePerson: e.target.value})
                      this.props.capturedLOData.nameOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('addressOfPerson')
                        ? this.props.capturedLOData.addressOfPerson
                        : this.state.addressOfThePerson
                    }
                    onChange={e => {
                      this.setState({ addressOfThePerson: e.target.value})
                      this.props.capturedLOData.addressOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedLOData &&
                      this.props.capturedLOData.hasOwnProperty('designation')
                        ? this.props.capturedLOData.designation
                        : this.state.designationOrStatus
                    }
                    onChange={e => {
                      this.setState({ designationOrStatus: e.target.value})
                      this.props.capturedLOData.designationOrStatus =
                      e.target.value
                    }}
                    required
                  />
