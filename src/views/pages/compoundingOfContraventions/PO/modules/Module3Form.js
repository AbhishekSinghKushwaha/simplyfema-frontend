...
class Module3Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedPOData && props.capturedPOData.background_input){
      let questions1 = props.capturedPOData.background_input
      this.setState({questions1})
      }

    if(props.capturedPOData && props.capturedPOData.natureofcontraventions_input){
      let questions2 = props.capturedPOData.natureofcontraventions_input
      this.setState({questions2})
      }

    if(props.capturedPOData && props.capturedPOData.delayreasons_input){
      let questions3 = props.capturedPOData.delayreasons_input
      this.setState({questions3})
      }
    
    if(props.capturedPOData && props.capturedPOData.petitionrequest_input){
      let questions4 = props.capturedPOData.petitionrequest_input
      this.setState({questions4})
      }

    if(props.capturedPOData && props.capturedPOData!== this.props.capturedPOData && props.capturedPOData.sample1){
        let sample1 = props.capturedPOData.sample1
        this.setState({sample1})
      }  

    if(props.capturedPOData && props.capturedPOData!== this.props.capturedPOData && props.capturedPOData.sample2){
        let sample2 = props.capturedPOData.sample2
        this.setState({sample2})
      } 

    if(props.capturedPOData && props.capturedPOData!== this.props.capturedPOData && props.capturedPOData.sample3){
        let sample3 = props.capturedPOData.sample3
        this.setState({sample3})
      }
      
      if(props.capturedPOData && props.capturedPOData!== this.props.capturedPOData && props.capturedPOData.sample4){
        let sample4 = props.capturedPOData.sample4
  ...
  handleText = (i, id) => e=> {
    ...
    if (id === 1) {
      ...
      this.props.capturedPOData.background = this.state.background;
    }
    if (id === 2) {
      let questions2 = [...this.state.questions2];
      questions2[i] = e.target.value;

      this.props.capturedPOData.natureofcontraventions =
    ...
    if (id === 3) {
      ...
      this.props.capturedPOData.delayreasons =
    ...
    if (id === 4) {
      ...
      this.props.capturedPOData.petitionrequest =
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedPOData.sample1 =
                                                              this.state.sample1
                                                        }}
                                                      />
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedPOData.sample2 =
                                                              this.state.sample2
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedPOData.sample3 =
                                                              this.state.sample3
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedPOData.sample4 =
                                                              this.state.sample4
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
...
//     this.props.capturedPOData.background1_input_1 =
//     this.state.background1_input_1
//     this.props.capturedPOData.background1_input_2 =
//     this.state.background1_input_2
//     this.props.capturedPOData.background1_input_3 =
//     this.state.background1_input_3
//     this.props.capturedPOData.background1_input_4 =
//     this.state.background1_input_4
//     this.props.capturedPOData.background1_input_5 =
//     this.state.background1_input_5
//     this.props.capturedPOData.background1_input_6 =
//     this.state.background1_input_6
//     this.props.capturedPOData.background1_input_7 =
//     this.state.background1_input_7
//     this.props.capturedPOData.background1_input_8 =
//     this.state.background1_input_8
//     this.props.capturedPOData.background1_input_9 =
//     this.state.background1_input_9
//     this.props.capturedPOData.background1_input_10 =
//     this.state.background1_input_10
//     this.props.capturedPOData.background1_input_11=
...
//     this.props.capturedPOData.background2_input_1 =
//     this.state.background2_input_1
//     this.props.capturedPOData.background2_input_2 =
//     this.state.background2_input_2
//     this.props.capturedPOData.background2_input_3 =
//     this.state.background2_input_3
//     this.props.capturedPOData.background2_input_4 =
//     this.state.background2_input_4
//     this.props.capturedPOData.background2_input_5 =
//     this.state.background2_input_5
//     this.props.capturedPOData.background2_input_6 =
//     this.state.background2_input_6
//     this.props.capturedPOData.background2_input_7 =
//     this.state.background2_input_7
//     this.props.capturedPOData.background2_input_8 =
//     this.state.background2_input_8
//     this.props.capturedPOData.background2_input_9 =
//     this.state.background2_input_9
//     this.props.capturedPOData.background2_input_10 =
//     this.state.background2_input_10
//     this.props.capturedPOData.background2_input_11=
...
//     this.props.capturedPOData.background3_input_1 =
//     this.state.background3_input_1
//     this.props.capturedPOData.background3_input_2 =
//     this.state.background3_input_2
//     this.props.capturedPOData.background3_input_3 =
//     this.state.background3_input_3
//     this.props.capturedPOData.background3_input_4 =
//     this.state.background3_input_4
//     this.props.capturedPOData.background3_input_5 =
//     this.state.background3_input_5
//     this.props.capturedPOData.background3_input_6 =
//     this.state.background3_input_6
//     this.props.capturedPOData.background3_input_7 =
//     this.state.background3_input_7
//     this.props.capturedPOData.background3_input_8 =
//     this.state.background3_input_8
//     this.props.capturedPOData.background3_input_9 =
//     this.state.background3_input_9
//     this.props.capturedPOData.background3_input_10 =
//     this.state.background3_input_10
//     this.props.capturedPOData.background3_input_11=
...
//     this.props.capturedPOData.background4_input_1 =
//     this.state.background4_input_1
//     this.props.capturedPOData.background4_input_2 =
//     this.state.background4_input_2
//     this.props.capturedPOData.background4_input_3 =
//     this.state.background4_input_3
//     this.props.capturedPOData.background4_input_4 =
//     this.state.background4_input_4
//     this.props.capturedPOData.background4_input_5 =
//     this.state.background4_input_5
//     this.props.capturedPOData.background4_input_6 =
//     this.state.background4_input_6
//     this.props.capturedPOData.background4_input_7 =
//     this.state.background4_input_7
//     this.props.capturedPOData.background4_input_8 =
//     this.state.background4_input_8
//     this.props.capturedPOData.background4_input_9 =
//     this.state.background4_input_9
//     this.props.capturedPOData.background4_input_10 =
//     this.state.background4_input_10
//     this.props.capturedPOData.background4_input_11=
...
//                         this.props.capturedPOData.sample1_1 =
...
//                         this.props.capturedPOData.sample1_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample1_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample2_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample2_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample2_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample3_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample3_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample3_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample4_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample4_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedPOData.sample4_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
