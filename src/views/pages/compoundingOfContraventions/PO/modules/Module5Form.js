...
class Module5Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedPOData.panNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedPOData.hasOwnProperty('nameOfPerson')
                        ? this.props.capturedPOData.nameOfPerson
                        : this.state.nameOfThePerson
                    }
                    onChange={e => {
                      this.setState({ nameOfThePerson: e.target.value})
                      this.props.capturedPOData.nameOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('addressOfPerson')
                        ? this.props.capturedPOData.addressOfPerson
                        : this.state.addressOfThePerson
                    }
                    onChange={e => {
                      this.setState({ addressOfThePerson: e.target.value})
                      this.props.capturedPOData.addressOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('designation')
                        ? this.props.capturedPOData.designation
                        : this.state.designationOrStatus
                    }
                    onChange={e => {
                      this.setState({ designationOrStatus: e.target.value})
                      this.props.capturedPOData.designationOrStatus =
                      e.target.value
                    }}
                    required
                  />
