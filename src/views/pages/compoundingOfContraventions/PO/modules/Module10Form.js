...
class Module10Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.setState({errors, [name]: value});
      ...
      this.props.capturedPOData.incomeTaxPan = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedPOData.hasOwnProperty('nameApplicant')
                        ? this.props.capturedPOData.nameApplicant
                        : this.state.nameOfApplicant
                    }
                    onChange={e => {
                      this.setState({ nameOfApplicant: e.target.value})
                      this.props.capturedPOData.nameOfApplicant =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>Date of incorporation</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedPOData &&
                    //   this.props.capturedPOData.hasOwnProperty('dateIncorporationbo')
                    //     ? new Date(this.props.capturedPOData.dateIncorporationbo)
                    //     : dateOfIncorporation
                    // }
                    onChange={dateOfIncorporation => {
                      ...
                      this.props.capturedPOData.dateIncorporationbo = new Date(
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('incometaxPan')
                        ? this.props.capturedPOData.incometaxPan
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('natureActivitiesUnderTakenwithNic')
                        ? this.props.capturedPOData.natureActivitiesUnderTakenwithNic
                        : this.state.natureOfActivitiesUnderTakenwithNic
                    }
                    onChange={e => {
                      this.setState({ natureOfActivitiesUnderTakenwithNic: e.target.value})
                      this.props.capturedPOData.natureOfActivitiesUnderTakenwithNic =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>Date of approval for opening of Liaison Office/ Branch Office</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedPOData &&
                    //   this.props.capturedPOData.hasOwnProperty('dateApprovalOffice')
                    //     ? new Date(this.props.capturedPOData.dateApprovalOffice)
                    ...
                    onChange={dateofApprovalOffice => {
                      ...
                      this.props.capturedPOData.dateApprovalOffice = new Date(
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('validityPeriodTheApproval')
                        ? this.props.capturedPOData.validityPeriodTheApproval
                        : this.state.validityPeriodOFTheApproval
                    }
                    onChange={e => {
                      this.setState({ validityPeriodOFTheApproval: e.target.value})
                      this.props.capturedPOData.validityPeriodOFTheApproval =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('incomeAndExpendiruteTheLoBo')
                        ? this.props.capturedPOData.incomeAndExpendiruteTheLoBo
                        : this.state.incomeAndExpendiruteOfTheLoBo
                    }
                    onChange={e => {
                      this.setState({ incomeAndExpendiruteOfTheLoBo: e.target.value})
                      this.props.capturedPOData.incomeAndExpendiruteOfTheLoBo =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('datesOfSubmissionAnnualActivityCertificates')
                        ? this.props.capturedPOData.datesOfSubmissionAnnualActivityCertificates
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedPOData.datesOfSubmissionOfAnnualActivityCertificates =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('natureContraventionsAndReasonsForTheContravention')
                        ? this.props.capturedPOData.natureContraventionsAndReasonsForTheContravention
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedPOData.natureOfContraventionsAndReasonsForTheContravention =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('allSupportingDocumentsMaySubmitted')
                        ? this.props.capturedPOData.allSupportingDocumentsMaySubmitted
                        : this.state.allSupportingDocumentsMayBeSubmitted
                    }
                    onChange={e => {
                      this.setState({ allSupportingDocumentsMayBeSubmitted: e.target.value})
                      this.props.capturedPOData.allSupportingDocumentsMayBeSubmitted =
                      e.target.value
                    }}
                    required
                  />
