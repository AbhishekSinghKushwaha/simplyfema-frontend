...
class Module1Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedPOData.officeFaxNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedPOData.hasOwnProperty('legalNameBusiness')
                        ? this.props.capturedPOData.legalNameBusiness
                        : this.state.legalNameOfBusiness
                    }
                    onChange={e => {
                      this.setState({ legalNameOfBusiness: e.target.value})
                      this.props.capturedPOData.legalNameOfBusiness =
                      e.target.value
                    }}
                    required
                    />
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={ 
                    //   this.props.capturedPOData &&
                    //   this.props.capturedPOData.hasOwnProperty('dateIncorporation')
                    //     ? new Date(this.props.capturedPOData.dateIncorporation)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      this.setState({dateOfIncorporation:enteredDate})
                      this.props.capturedPOData.dateIncorporation = new Date(
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('panNumber')
                        ? this.props.capturedPOData.panNumber
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('cinNumber')
                        ? this.props.capturedPOData.cinNumber
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedPOData.hasOwnProperty(
                          ...
                          ? this.props.capturedPOData.selectnicOption
                          : NicOptions[0].label,
                      value:
                        this.props.capturedPOData &&
                        this.props.capturedPOData.hasOwnProperty(
                    ...
                    onChange={
                      ...
                      this.props.capturedPOData.selectnicOption = selectNicOption.label
                    }}
                    required
                    />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('mainactivities')
                        ? this.props.capturedPOData.mainactivities
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('additionalactivities')
                        ? this.props.capturedPOData.additionalactivities
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedPOData.hasOwnProperty(
                          ...
                          ? this.props.capturedPOData.selectactivityOption
                    ...
                    onChange={selectActivityOption => {
                      ...
                      this.props.capturedPOData.selectactivityOption = selectActivityOption.label
                    }}
                    required
                    />
                  <AvFeedback>
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('buildingNo')
                        ? this.props.capturedPOData.buildingNo
                        : this.state.buildingNumber
                    }
                    onChange={e => {
                      this.setState({ buildingNumber: e.target.value})
                      this.props.capturedPOData.buildingNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('floorNo')
                        ? this.props.capturedPOData.floorNo
                        : this.state.floorNumber
                    }
                    onChange={e => {
                      this.setState({ floorNumber: e.target.value})
                      this.props.capturedPOData.floorNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('nameThePremisesOrBuilding')
                        ? this.props.capturedPOData.nameThePremisesOrBuilding
                        : this.state.nameOfThePremisesOrBuilding
                    }
                    onChange={e => {
                      this.setState({ nameOfThePremisesOrBuilding: e.target.value})
                      this.props.capturedPOData.nameOfThePremisesOrBuilding =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('Street')
                        ? this.props.capturedPOData.Street
                        : this.state.roadOrStreet
                    }
                    onChange={e => {
                      this.setState({ roadOrStreet: e.target.value})
                      this.props.capturedPOData.roadOrStreet =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('Area')
                        ? this.props.capturedPOData.Area
                        : this.state.area
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('City')
                        ? this.props.capturedPOData.City
                        : this.state.cityOrTownOrLocalityOrVillage
                    }
                    onChange={e => {
                      this.setState({ cityOrTownOrLocalityOrVillage: e.target.value})
                      this.props.capturedPOData.cityOrTownOrLocalityOrVillage =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('State')
                        ? this.props.capturedPOData.State
                        : this.state.state
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('Country')
                        ? this.props.capturedPOData.Country
                        : this.state.country
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('Pincode')
                        ? this.props.capturedPOData.Pincode
                        : this.state.pincode
                    }
                    onChange={e => {
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('officeemailAddress')
                        ? this.props.capturedPOData.officeemailAddress
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('mobileNo')
                        ? this.props.capturedPOData.mobileNo
                        : this.state.mobileNumber
                    }
                    onChange={e => {
                      this.setState({ mobileNumber: e.target.value})
                      this.props.capturedPOData.mobileNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('officeTelephoneNo')
                        ? this.props.capturedPOData.officeTelephoneNo
                        : this.state.officeTelephoneNumber
                    }
                    onChange={e => {
                      this.setState({ officeTelephoneNumber: e.target.value})
                      this.props.capturedPOData.officeTelephoneNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedPOData &&
                      this.props.capturedPOData.hasOwnProperty('officeFaxNo')
                        ? this.props.capturedPOData.officeFaxNo
