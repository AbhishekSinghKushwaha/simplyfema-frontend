...
class Module3Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedODIData && props.capturedODIData.background_input){
      let questions1 = props.capturedODIData.background_input
      this.setState({questions1})
      }

    if(props.capturedODIData && props.capturedODIData.natureofcontraventions_input){
      let questions2 = props.capturedODIData.natureofcontraventions_input
      this.setState({questions2})
      }

    if(props.capturedODIData && props.capturedODIData.delayreasons_input){
      let questions3 = props.capturedODIData.delayreasons_input
      this.setState({questions3})
      }
    
    if(props.capturedODIData && props.capturedODIData.petitionrequest_input){
      let questions4 = props.capturedODIData.petitionrequest_input
      this.setState({questions4})
      }

    if(props.capturedODIData && props.capturedODIData!== this.props.capturedODIData && props.capturedODIData.sample1){
        let sample1 = props.capturedODIData.sample1
        this.setState({sample1})
      }  

    if(props.capturedODIData && props.capturedODIData!== this.props.capturedODIData && props.capturedODIData.sample2){
        let sample2 = props.capturedODIData.sample2
        this.setState({sample2})
      } 

    if(props.capturedODIData && props.capturedODIData!== this.props.capturedODIData && props.capturedODIData.sample3){
        let sample3 = props.capturedODIData.sample3
        this.setState({sample3})
      }
      
      if(props.capturedODIData && props.capturedODIData!== this.props.capturedODIData && props.capturedODIData.sample4){
        let sample4 = props.capturedODIData.sample4
  ...
  handleText = (i, id) => e=> {
    ...
    if (id === 1) {
      ...
      this.props.capturedODIData.background = this.state.background;
    }
    if (id === 2) {
      let questions2 = [...this.state.questions2];
      questions2[i] = e.target.value;

      this.props.capturedODIData.natureofcontraventions =
    ...
    if (id === 3) {
      ...
      this.props.capturedODIData.delayreasons =
    ...
    if (id === 4) {
      ...
      this.props.capturedODIData.petitionrequest =
                              ...
                              >
                                <Input
                                  ...
                                  value={
                                    ...
                                    this.props.capturedODIData.hasOwnProperty(
                                      "background_input"
                                    )
                                      ? this.props.capturedODIData
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedODIData.sample1 =
                                                              this.state.sample1
                                                        }}
                                                      />
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedODIData.sample2 =
                                                              this.state.sample2
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedODIData.sample3 =
                                                              this.state.sample3
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedODIData.sample4 =
                                                              this.state.sample4
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
...
//     this.props.capturedODIData.background1_input_1 =
//     this.state.background1_input_1
//     this.props.capturedODIData.background1_input_2 =
//     this.state.background1_input_2
//     this.props.capturedODIData.background1_input_3 =
//     this.state.background1_input_3
//     this.props.capturedODIData.background1_input_4 =
//     this.state.background1_input_4
//     this.props.capturedODIData.background1_input_5 =
//     this.state.background1_input_5
//     this.props.capturedODIData.background1_input_6 =
//     this.state.background1_input_6
//     this.props.capturedODIData.background1_input_7 =
//     this.state.background1_input_7
//     this.props.capturedODIData.background1_input_8 =
//     this.state.background1_input_8
//     this.props.capturedODIData.background1_input_9 =
//     this.state.background1_input_9
//     this.props.capturedODIData.background1_input_10 =
//     this.state.background1_input_10
//     this.props.capturedODIData.background1_input_11=
...
//     this.props.capturedODIData.background2_input_1 =
//     this.state.background2_input_1
//     this.props.capturedODIData.background2_input_2 =
//     this.state.background2_input_2
//     this.props.capturedODIData.background2_input_3 =
//     this.state.background2_input_3
//     this.props.capturedODIData.background2_input_4 =
//     this.state.background2_input_4
//     this.props.capturedODIData.background2_input_5 =
//     this.state.background2_input_5
//     this.props.capturedODIData.background2_input_6 =
//     this.state.background2_input_6
//     this.props.capturedODIData.background2_input_7 =
//     this.state.background2_input_7
//     this.props.capturedODIData.background2_input_8 =
//     this.state.background2_input_8
//     this.props.capturedODIData.background2_input_9 =
//     this.state.background2_input_9
//     this.props.capturedODIData.background2_input_10 =
//     this.state.background2_input_10
//     this.props.capturedODIData.background2_input_11=
...
//     this.props.capturedODIData.background3_input_1 =
//     this.state.background3_input_1
//     this.props.capturedODIData.background3_input_2 =
//     this.state.background3_input_2
//     this.props.capturedODIData.background3_input_3 =
//     this.state.background3_input_3
//     this.props.capturedODIData.background3_input_4 =
//     this.state.background3_input_4
//     this.props.capturedODIData.background3_input_5 =
//     this.state.background3_input_5
//     this.props.capturedODIData.background3_input_6 =
//     this.state.background3_input_6
//     this.props.capturedODIData.background3_input_7 =
//     this.state.background3_input_7
//     this.props.capturedODIData.background3_input_8 =
//     this.state.background3_input_8
//     this.props.capturedODIData.background3_input_9 =
//     this.state.background3_input_9
//     this.props.capturedODIData.background3_input_10 =
//     this.state.background3_input_10
//     this.props.capturedODIData.background3_input_11=
...
//     this.props.capturedODIData.background4_input_1 =
//     this.state.background4_input_1
//     this.props.capturedODIData.background4_input_2 =
//     this.state.background4_input_2
//     this.props.capturedODIData.background4_input_3 =
//     this.state.background4_input_3
//     this.props.capturedODIData.background4_input_4 =
//     this.state.background4_input_4
//     this.props.capturedODIData.background4_input_5 =
//     this.state.background4_input_5
//     this.props.capturedODIData.background4_input_6 =
//     this.state.background4_input_6
//     this.props.capturedODIData.background4_input_7 =
//     this.state.background4_input_7
//     this.props.capturedODIData.background4_input_8 =
//     this.state.background4_input_8
//     this.props.capturedODIData.background4_input_9 =
//     this.state.background4_input_9
//     this.props.capturedODIData.background4_input_10 =
//     this.state.background4_input_10
//     this.props.capturedODIData.background4_input_11=
...
//                         this.props.capturedODIData.sample1_1 =
...
//                         this.props.capturedODIData.sample1_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample1_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample2_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample2_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample2_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample3_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample3_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample3_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample4_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample4_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedODIData.sample4_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
