...
class Module2Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedODIData && props.capturedODIData.topicNameDescription){
    let questions = props.capturedODIData.topicNameDescription
    this.setState({questions})
    }

    if(props.capturedODIData && props.capturedODIData.rbiReferenceLetter){
      let questions2 = props.capturedODIData.rbiReferenceLetter
      this.setState({questions2})
      }

      if(props.capturedODIData && props.capturedODIData!== this.props.capturedODIData && props.capturedODIData.sampleOthers){
        let sampleOthers = props.capturedODIData.sampleOthers
        this.setState({sampleOthers})
      }


      if(props.capturedODIData && props.capturedODIData!== this.props.capturedODIData && props.capturedODIData.sampleRbi){
        let sampleRbi = props.capturedODIData.sampleRbi
  ...
  handleChange = (e) => {
    ...
    this.props.capturedODIData.officeTeleNumber = e.target.value
  }
  ...
  handleText = i => e => {
    ...
    this.props.capturedODIData.input1 = 
    this.state.input1
  }
  ...
  addInput = e => {
    //let questions = []
    //e.preventDefault()
    // if(this.props.capturedODIData.topicNameDescription){
    //   questions = this.props.capturedODIData.topicNameDescription.concat([...this.state.questions])
    //   }
    // else{
  ...
  this.props.capturedODIData.rbiLetter = 
  ...
  addInput2 = (e) => {
    // e.preventDefault()
    // let questions2 = []
    // if(this.props.capturedODIData.rbiReferenceLetter){
    //   questions2 = this.props.capturedODIData.rbiReferenceLetter.concat([...this.state.questions2])
    //   }
    // else{
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedODIData.hasOwnProperty('natureContravention')
                        ? this.props.capturedODIData.natureContravention
                        : this.state.natureOfContravention
                    }
                    onChange={e => {
                      this.setState({ natureOfContravention: e.target.value})
                      this.props.capturedODIData.natureOfContravention =
                      e.target.value
                    }}
                    required
                  />
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedODIData.hasOwnProperty(
                          ...
                          ? this.props.capturedODIData.selectFema
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedODIData.hasOwnProperty(
                          ...
                          ? this.props.capturedODIData.selectRegulationNo
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='input1'>Others - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedODIData &&
          this.props.capturedODIData.hasOwnProperty('topicNameDescription')
            ? this.props.capturedODIData.topicNameDescription[index]
                  ...
                  <Checkbox
                    ...
                    onChange = {checkedValue => {
                      this.setState(prevState => {
                       ...
                       this.props.capturedODIData.sampleOthers =
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedODIData.hasOwnProperty(
                          ...
                          ? this.props.capturedODIData.selectCAAoption
                          : CAAOptions[0].label,
                      value:
                        this.props.capturedODIData &&
                        this.props.capturedODIData.hasOwnProperty(
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedODIData.hasOwnProperty(
                          ...
                          ? this.props.capturedODIData.selectcentralOptions
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('subjectCompounding')
                        ? this.props.capturedODIData.subjectCompounding
                        : this.state.subjectOfCompounding
                    }
                    onChange={e => {
                      this.setState({ subjectOfCompounding: e.target.value})
                      this.props.capturedODIData.subjectOfCompounding =
                      e.target.value
                    }}
                    required
                  />
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    icon={<Check className='vx-icon' size={16} />}
                    label=''
                    checked={this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('sample_subjectOfCompounding_1')
                        ? this.props.capturedODIData.sample_subjectOfCompounding_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('sample_subjectOfCompounding_2')
                        ? this.props.capturedODIData.sample_subjectOfCompounding_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('sample_subjectOfCompounding_3')
                        ? this.props.capturedODIData.sample_subjectOfCompounding_3
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>RBI Reference Letter - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedODIData &&
          this.props.capturedODIData.hasOwnProperty('rbiReferenceLetter')
            ? this.props.capturedODIData.rbiReferenceLetter[index]
            : this.state.rbiLetter[index]
        }
        //value={question}
        // onChange={e => {
        //   this.setState({ rbiReferenceLetter: e.target.value})
        //   this.props.capturedODIData.rbiReferenceLetter =
        //   e.target.value
        // }}
        required
      />
                  ...
                  <Checkbox
                   ...
                   onChange = {checkedValue => {
                     ...
                     this.setState(prevState => {
                      ...
                      this.props.capturedODIData.sampleRbi =
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('residentoutsideIndia')
                        ? this.props.capturedODIData.residentoutsideIndia
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('sample_indiaOrNot_1')
                        ? this.props.capturedODIData.sample_indiaOrNot_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('sample_indiaOrNot_2')
                        ? this.props.capturedODIData.sample_indiaOrNot_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('sample_indiaOrNot_3')
                        ? this.props.capturedODIData.sample_indiaOrNot_3
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('nameAdjudicatingAuthority')
                        ? this.props.capturedODIData.nameAdjudicatingAuthority
                        : this.state.nameOfAdjudicatingAuthority
                    }
                    onChange={e => {
                      this.setState({ nameOfAdjudicatingAuthority: e.target.value})
                      this.props.capturedODIData.nameOfAdjudicatingAuthority =
                      e.target.value
                    }}
                    required
                  />
        ...
        <div style={{width:'25%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('compoundingApplicationfee')
                        ? this.props.capturedODIData.compoundingApplicationfee
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedODIData &&
                    //   this.props.capturedODIData.hasOwnProperty('dateIncorporationmod2')
                    //     ? new Date(this.props.capturedODIData.dateIncorporationmod2)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      ...
                      this.props.capturedODIData.dateIncorporationmod2 = new Date(
        ...
        <div style={{width:'26%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('officeTeleNo')
                        ? this.props.capturedODIData.officeTeleNo
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedODIData.hasOwnProperty(
                          ...
                          ? this.props.capturedODIData.selectpayOption
                          : PayOptions[0].label,
                      value:
                        this.props.capturedODIData &&
                        this.props.capturedODIData.hasOwnProperty(
