...
class Module5Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedODIData.panNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedODIData.hasOwnProperty('nameOfPerson')
                        ? this.props.capturedODIData.nameOfPerson
                        : this.state.nameOfThePerson
                    }
                    onChange={e => {
                      this.setState({ nameOfThePerson: e.target.value})
                      this.props.capturedODIData.nameOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('addressOfPerson')
                        ? this.props.capturedODIData.addressOfPerson
                        : this.state.addressOfThePerson
                    }
                    onChange={e => {
                      this.setState({ addressOfThePerson: e.target.value})
                      this.props.capturedODIData.addressOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedODIData &&
                      this.props.capturedODIData.hasOwnProperty('designation')
                        ? this.props.capturedODIData.designation
                        : this.state.designationOrStatus
                    }
                    onChange={e => {
                      this.setState({ designationOrStatus: e.target.value})
                      this.props.capturedODIData.designationOrStatus =
                      e.target.value
                    }}
                    required
                  />
