      ...
      <div >
          ...
          <tbody>
            <tr>
              ...
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '531.4px'}}>
                <p style={{paddingLeft: '5px'}}><span style={{backgroundColor: '#ffff00'}}><strong><strong>{this.props.dataCaptured.nameofApplicant}</strong></strong></span></p>
              </td>
            </tr>
            <tr>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '205.6px'}}>
              ...
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '531.4px'}}>
                <p style={{paddingLeft: '5px'}}><span style={{backgroundColor: '#ffff00'}}><strong><strong>{this.props.dataCaptured.dateOfIncorporation}</strong></strong></span></p>
              </td>
            </tr>
            <tr>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '205.6px'}}>
              ...
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '531.4px'}}>
                <p style={{paddingLeft: '5px'}}><span style={{backgroundColor: '#ffff00'}}><strong><strong>{this.props.dataCaptured.incomeTaxPan}</strong></strong></span></p>
              </td>
            </tr>
            <tr>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '205.6px'}}>
              ...
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '531.4px'}}>
                <p style={{paddingLeft: '5px'}}><span style={{backgroundColor: '#ffff00'}}><strong><strong>{this.props.dataCaptured.natureOfActivitiesUnderTakenNicCode}</strong></strong></span></p>
              </td>
            </tr>
            <tr>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse" ,width: '205.6px'}}>
        ...
        <table style={{borderColor: 'black', borderCollapse: 'collapse'}} border=".5">
          <tbody>
            ...
            <tr>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={197}>
                <p>&nbsp;  {this.props.dataCaptured.TCslNo}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={94}>
                <p>&nbsp; {this.props.dataCaptured.TcnameOfRemitter}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={101}>
                <p>&nbsp; {this.props.dataCaptured.TCtotalAmountINR}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={101}>
                <p>&nbsp; {this.props.dataCaptured.dateOfRecieptTC}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={91}>
                <p>&nbsp; {this.props.dataCaptured.TCExcessShareApplicationMoney}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={91}>
                <p>&nbsp; {this.props.dataCaptured.dateOfRefundTC}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={91}>
                <p>&nbsp; {this.props.dataCaptured.TCamountInForex}</p>
              </td>
              <td style={{display:"inlineBlock" , verticalAlign:"middle",   border:"1px solid black"  , borderCollapse:"collapse"}} width={91}>
                <p>&nbsp; {this.props.dataCaptured.rbiLetterTC}</p>
              </td>
            </tr>
          </tbody>
        </table>
