...
class VuexyWizard extends React.Component {
  ...
  render () {
    ...
    const params = {
      ...
      <div  className={"swiper-button-prev lala lalaone  "}></div>,
                ...
                >
                  ...
                  {this.props.pagination ? (
                    <div className='wizard-actions d-flex justify-content-between'>
                      ...
                      onClick = {this.props.steps.length - 1 === i &&!this.props.finishBtnText&&this.props.update}
                      >
...
VuexyWizard.propTypes = {
  ...
  capturedBOData: PropTypes.object
}
