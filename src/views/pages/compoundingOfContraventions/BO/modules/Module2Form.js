...
class Module2Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedBOData && props.capturedBOData.topicNameDescription){
    let questions = props.capturedBOData.topicNameDescription
    this.setState({questions})
    }

    if(props.capturedBOData && props.capturedBOData.rbiReferenceLetter){
      let questions2 = props.capturedBOData.rbiReferenceLetter
      this.setState({questions2})
      }

      if(props.capturedBOData && props.capturedBOData!== this.props.capturedBOData && props.capturedBOData.sampleOthers){
        let sampleOthers = props.capturedBOData.sampleOthers
        this.setState({sampleOthers})
      }


      if(props.capturedBOData && props.capturedBOData!== this.props.capturedBOData && props.capturedBOData.sampleRbi){
        let sampleRbi = props.capturedBOData.sampleRbi
  ...
  handleChange = (e) => {
    ...
    this.props.capturedBOData.officeTeleNumber = e.target.value
  }
  ...
  handleText = i => e => {
    ...
    this.props.capturedBOData.input1 = 
    this.state.input1
  }
  ...
  addInput = e => {
    //let questions = []
    //e.preventDefault()
    // if(this.props.capturedBOData.topicNameDescription){
    //   questions = this.props.capturedBOData.topicNameDescription.concat([...this.state.questions])
    //   }
    // else{
  ...
  this.props.capturedBOData.rbiLetter = 
  ...
  addInput2 = (e) => {
    // e.preventDefault()
    // let questions2 = []
    // if(this.props.capturedBOData.rbiReferenceLetter){
    //   questions2 = this.props.capturedBOData.rbiReferenceLetter.concat([...this.state.questions2])
    //   }
    // else{
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedBOData.hasOwnProperty('natureContravention')
                        ? this.props.capturedBOData.natureContravention
                        : this.state.natureOfContravention
                    }
                    onChange={e => {
                      this.setState({ natureOfContravention: e.target.value})
                      this.props.capturedBOData.natureOfContravention =
                      e.target.value
                    }}
                    required
                  />
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectFema
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectRegulationNo
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='input1'>Others - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedBOData &&
          this.props.capturedBOData.hasOwnProperty('topicNameDescription')
            ? this.props.capturedBOData.topicNameDescription[index]
                  ...
                  <Checkbox
                    ...
                    onChange = {checkedValue => {
                      this.setState(prevState => {
                       ...
                       this.props.capturedBOData.sampleOthers =
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectCAAoption
                          : CAAOptions[0].label,
                      value:
                        this.props.capturedBOData &&
                        this.props.capturedBOData.hasOwnProperty(
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectcentralOptions
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('subjectCompounding')
                        ? this.props.capturedBOData.subjectCompounding
                        : this.state.subjectOfCompounding
                    }
                    onChange={e => {
                      this.setState({ subjectOfCompounding: e.target.value})
                      this.props.capturedBOData.subjectOfCompounding =
                      e.target.value
                    }}
                    required
                  />
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    icon={<Check className='vx-icon' size={16} />}
                    label=''
                    checked={this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('sample_subjectOfCompounding_1')
                        ? this.props.capturedBOData.sample_subjectOfCompounding_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('sample_subjectOfCompounding_2')
                        ? this.props.capturedBOData.sample_subjectOfCompounding_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('sample_subjectOfCompounding_3')
                        ? this.props.capturedBOData.sample_subjectOfCompounding_3
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>RBI Reference Letter - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedBOData &&
          this.props.capturedBOData.hasOwnProperty('rbiReferenceLetter')
            ? this.props.capturedBOData.rbiReferenceLetter[index]
            : this.state.rbiLetter[index]
        }
        //value={question}
        // onChange={e => {
        //   this.setState({ rbiReferenceLetter: e.target.value})
        //   this.props.capturedBOData.rbiReferenceLetter =
        //   e.target.value
        // }}
        required
      />
                  ...
                  <Checkbox
                   ...
                   onChange = {checkedValue => {
                     ...
                     this.setState(prevState => {
                      ...
                      this.props.capturedBOData.sampleRbi =
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('residentoutsideIndia')
                        ? this.props.capturedBOData.residentoutsideIndia
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('sample_indiaOrNot_1')
                        ? this.props.capturedBOData.sample_indiaOrNot_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('sample_indiaOrNot_2')
                        ? this.props.capturedBOData.sample_indiaOrNot_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('sample_indiaOrNot_3')
                        ? this.props.capturedBOData.sample_indiaOrNot_3
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('nameAdjudicatingAuthority')
                        ? this.props.capturedBOData.nameAdjudicatingAuthority
                        : this.state.nameOfAdjudicatingAuthority
                    }
                    onChange={e => {
                      this.setState({ nameOfAdjudicatingAuthority: e.target.value})
                      this.props.capturedBOData.nameOfAdjudicatingAuthority =
                      e.target.value
                    }}
                    required
                  />
        ...
        <div style={{width:'25%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('compoundingApplicationfee')
                        ? this.props.capturedBOData.compoundingApplicationfee
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedBOData &&
                    //   this.props.capturedBOData.hasOwnProperty('dateIncorporationmod2')
                    //     ? new Date(this.props.capturedBOData.dateIncorporationmod2)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      ...
                      this.props.capturedBOData.dateIncorporationmod2 = new Date(
        ...
        <div style={{width:'26%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('officeTeleNo')
                        ? this.props.capturedBOData.officeTeleNo
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectpayOption
                          : PayOptions[0].label,
                      value:
                        this.props.capturedBOData &&
                        this.props.capturedBOData.hasOwnProperty(
