...
class Module10Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.setState({errors, [name]: value});
      ...
      this.props.capturedBOData.incomeTaxPan = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedBOData.hasOwnProperty('nameApplicant')
                        ? this.props.capturedBOData.nameApplicant
                        : this.state.nameOfApplicant
                    }
                    onChange={e => {
                      this.setState({ nameOfApplicant: e.target.value})
                      this.props.capturedBOData.nameOfApplicant =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>Date of incorporation</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedBOData &&
                    //   this.props.capturedBOData.hasOwnProperty('dateIncorporationbo')
                    //     ? new Date(this.props.capturedBOData.dateIncorporationbo)
                    //     : dateOfIncorporation
                    // }
                    onChange={dateOfIncorporation => {
                      ...
                      this.props.capturedBOData.dateIncorporationbo = new Date(
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('incometaxPan')
                        ? this.props.capturedBOData.incometaxPan
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('natureActivitiesUnderTakenwithNic')
                        ? this.props.capturedBOData.natureActivitiesUnderTakenwithNic
                        : this.state.natureOfActivitiesUnderTakenwithNic
                    }
                    onChange={e => {
                      this.setState({ natureOfActivitiesUnderTakenwithNic: e.target.value})
                      this.props.capturedBOData.natureOfActivitiesUnderTakenwithNic =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>Date of approval for opening of Liaison Office/ Branch Office</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedBOData &&
                    //   this.props.capturedBOData.hasOwnProperty('dateApprovalOffice')
                    //     ? new Date(this.props.capturedBOData.dateApprovalOffice)
                    ...
                    onChange={dateofApprovalOffice => {
                      ...
                      this.props.capturedBOData.dateApprovalOffice = new Date(
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('validityPeriodTheApproval')
                        ? this.props.capturedBOData.validityPeriodTheApproval
                        : this.state.validityPeriodOFTheApproval
                    }
                    onChange={e => {
                      this.setState({ validityPeriodOFTheApproval: e.target.value})
                      this.props.capturedBOData.validityPeriodOFTheApproval =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('incomeAndExpendiruteTheLoBo')
                        ? this.props.capturedBOData.incomeAndExpendiruteTheLoBo
                        : this.state.incomeAndExpendiruteOfTheLoBo
                    }
                    onChange={e => {
                      this.setState({ incomeAndExpendiruteOfTheLoBo: e.target.value})
                      this.props.capturedBOData.incomeAndExpendiruteOfTheLoBo =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('datesOfSubmissionAnnualActivityCertificates')
                        ? this.props.capturedBOData.datesOfSubmissionAnnualActivityCertificates
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedBOData.datesOfSubmissionOfAnnualActivityCertificates =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('natureContraventionsAndReasonsForTheContravention')
                        ? this.props.capturedBOData.natureContraventionsAndReasonsForTheContravention
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedBOData.natureOfContraventionsAndReasonsForTheContravention =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('allSupportingDocumentsMaySubmitted')
                        ? this.props.capturedBOData.allSupportingDocumentsMaySubmitted
                        : this.state.allSupportingDocumentsMayBeSubmitted
                    }
                    onChange={e => {
                      this.setState({ allSupportingDocumentsMayBeSubmitted: e.target.value})
                      this.props.capturedBOData.allSupportingDocumentsMayBeSubmitted =
                      e.target.value
                    }}
                    required
                  />
