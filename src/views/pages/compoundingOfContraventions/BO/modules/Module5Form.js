...
class Module5Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedBOData.panNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedBOData.hasOwnProperty('nameOfPerson')
                        ? this.props.capturedBOData.nameOfPerson
                        : this.state.nameOfThePerson
                    }
                    onChange={e => {
                      this.setState({ nameOfThePerson: e.target.value})
                      this.props.capturedBOData.nameOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('addressOfPerson')
                        ? this.props.capturedBOData.addressOfPerson
                        : this.state.addressOfThePerson
                    }
                    onChange={e => {
                      this.setState({ addressOfThePerson: e.target.value})
                      this.props.capturedBOData.addressOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('designation')
                        ? this.props.capturedBOData.designation
                        : this.state.designationOrStatus
                    }
                    onChange={e => {
                      this.setState({ designationOrStatus: e.target.value})
                      this.props.capturedBOData.designationOrStatus =
                      e.target.value
                    }}
                    required
                  />
