...
class Module3Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedBOData && props.capturedBOData.background_input){
      let questions1 = props.capturedBOData.background_input
      this.setState({questions1})
      }

    if(props.capturedBOData && props.capturedBOData.natureofcontraventions_input){
      let questions2 = props.capturedBOData.natureofcontraventions_input
      this.setState({questions2})
      }

    if(props.capturedBOData && props.capturedBOData.delayreasons_input){
      let questions3 = props.capturedBOData.delayreasons_input
      this.setState({questions3})
      }
    
    if(props.capturedBOData && props.capturedBOData.petitionrequest_input){
      let questions4 = props.capturedBOData.petitionrequest_input
      this.setState({questions4})
      }

    if(props.capturedBOData && props.capturedBOData!== this.props.capturedBOData && props.capturedBOData.sample1){
        let sample1 = props.capturedBOData.sample1
        this.setState({sample1})
      }  

    if(props.capturedBOData && props.capturedBOData!== this.props.capturedBOData && props.capturedBOData.sample2){
        let sample2 = props.capturedBOData.sample2
        this.setState({sample2})
      } 

    if(props.capturedBOData && props.capturedBOData!== this.props.capturedBOData && props.capturedBOData.sample3){
        let sample3 = props.capturedBOData.sample3
        this.setState({sample3})
      }
      
      if(props.capturedBOData && props.capturedBOData!== this.props.capturedBOData && props.capturedBOData.sample4){
        let sample4 = props.capturedBOData.sample4
  ...
  handleText = (i, id) => e=> {
    ...
    if (id === 1) {
      ...
      this.props.capturedBOData.background = this.state.background;
    }
    if (id === 2) {
      let questions2 = [...this.state.questions2];
      questions2[i] = e.target.value;

      this.props.capturedBOData.natureofcontraventions =
    ...
    if (id === 3) {
      ...
      this.props.capturedBOData.delayreasons =
    ...
    if (id === 4) {
      ...
      this.props.capturedBOData.petitionrequest =
                            ...
                            <Col sm="10">
                              ...
                              >
                                <Input
                                  ...
                                  value={
                                    this.props.capturedBOData &&
                                    this.props.capturedBOData.hasOwnProperty(
                                      "background_input"
                                    )
                                      ? this.props.capturedBOData
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedBOData.sample1 =
                                                              this.state.sample1
                                                        }}
                                                      />
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedBOData.sample2 =
                                                              this.state.sample2
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedBOData.sample3 =
                                                              this.state.sample3
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
                                                      ...
                                                      <Checkbox
                                                        ...
                                                        onChange = {checkedValue => {
                                                          ...
                                                          this.setState(prevState => {
                                                           ...
                                                           this.props.capturedBOData.sample4 =
                                                              this.state.sample4
                                                        }}
                                                      />
                                                      <h2 style={{fontSize: "20px", width: "110px", padding: "3px"}}                                                   >
...
//     this.props.capturedBOData.background1_input_1 =
//     this.state.background1_input_1
//     this.props.capturedBOData.background1_input_2 =
//     this.state.background1_input_2
//     this.props.capturedBOData.background1_input_3 =
//     this.state.background1_input_3
//     this.props.capturedBOData.background1_input_4 =
//     this.state.background1_input_4
//     this.props.capturedBOData.background1_input_5 =
//     this.state.background1_input_5
//     this.props.capturedBOData.background1_input_6 =
//     this.state.background1_input_6
//     this.props.capturedBOData.background1_input_7 =
//     this.state.background1_input_7
//     this.props.capturedBOData.background1_input_8 =
//     this.state.background1_input_8
//     this.props.capturedBOData.background1_input_9 =
//     this.state.background1_input_9
//     this.props.capturedBOData.background1_input_10 =
//     this.state.background1_input_10
//     this.props.capturedBOData.background1_input_11=
...
//     this.props.capturedBOData.background2_input_1 =
//     this.state.background2_input_1
//     this.props.capturedBOData.background2_input_2 =
//     this.state.background2_input_2
//     this.props.capturedBOData.background2_input_3 =
//     this.state.background2_input_3
//     this.props.capturedBOData.background2_input_4 =
//     this.state.background2_input_4
//     this.props.capturedBOData.background2_input_5 =
//     this.state.background2_input_5
//     this.props.capturedBOData.background2_input_6 =
//     this.state.background2_input_6
//     this.props.capturedBOData.background2_input_7 =
//     this.state.background2_input_7
//     this.props.capturedBOData.background2_input_8 =
//     this.state.background2_input_8
//     this.props.capturedBOData.background2_input_9 =
//     this.state.background2_input_9
//     this.props.capturedBOData.background2_input_10 =
//     this.state.background2_input_10
//     this.props.capturedBOData.background2_input_11=
...
//     this.props.capturedBOData.background3_input_1 =
//     this.state.background3_input_1
//     this.props.capturedBOData.background3_input_2 =
//     this.state.background3_input_2
//     this.props.capturedBOData.background3_input_3 =
//     this.state.background3_input_3
//     this.props.capturedBOData.background3_input_4 =
//     this.state.background3_input_4
//     this.props.capturedBOData.background3_input_5 =
//     this.state.background3_input_5
//     this.props.capturedBOData.background3_input_6 =
//     this.state.background3_input_6
//     this.props.capturedBOData.background3_input_7 =
//     this.state.background3_input_7
//     this.props.capturedBOData.background3_input_8 =
//     this.state.background3_input_8
//     this.props.capturedBOData.background3_input_9 =
//     this.state.background3_input_9
//     this.props.capturedBOData.background3_input_10 =
//     this.state.background3_input_10
//     this.props.capturedBOData.background3_input_11=
...
//     this.props.capturedBOData.background4_input_1 =
//     this.state.background4_input_1
//     this.props.capturedBOData.background4_input_2 =
//     this.state.background4_input_2
//     this.props.capturedBOData.background4_input_3 =
//     this.state.background4_input_3
//     this.props.capturedBOData.background4_input_4 =
//     this.state.background4_input_4
//     this.props.capturedBOData.background4_input_5 =
//     this.state.background4_input_5
//     this.props.capturedBOData.background4_input_6 =
//     this.state.background4_input_6
//     this.props.capturedBOData.background4_input_7 =
//     this.state.background4_input_7
//     this.props.capturedBOData.background4_input_8 =
//     this.state.background4_input_8
//     this.props.capturedBOData.background4_input_9 =
//     this.state.background4_input_9
//     this.props.capturedBOData.background4_input_10 =
//     this.state.background4_input_10
//     this.props.capturedBOData.background4_input_11=
...
//                         this.props.capturedBOData.sample1_1 =
...
//                         this.props.capturedBOData.sample1_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample1_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample2_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample2_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample2_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample3_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample3_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample3_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample4_1 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample4_2 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
...
//                         this.props.capturedBOData.sample4_3 =
//                           checkedValue.target.checked
//                     }}
//                   />
//                 </dt>
