...
class Module1Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedBOData.officeFaxNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedBOData.hasOwnProperty('legalNameBusiness')
                        ? this.props.capturedBOData.legalNameBusiness
                        : this.state.legalNameOfBusiness
                    }
                    onChange={e => {
                      this.setState({ legalNameOfBusiness: e.target.value})
                      this.props.capturedBOData.legalNameOfBusiness =
                      e.target.value
                    }}
                    required
                    />
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={ 
                    //   this.props.capturedBOData &&
                    //   this.props.capturedBOData.hasOwnProperty('dateIncorporation')
                    //     ? new Date(this.props.capturedBOData.dateIncorporation)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      this.setState({dateOfIncorporation:enteredDate})
                      this.props.capturedBOData.dateIncorporation = new Date(
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('panNumber')
                        ? this.props.capturedBOData.panNumber
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('cinNumber')
                        ? this.props.capturedBOData.cinNumber
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectnicOption
                          : NicOptions[0].label,
                      value:
                        this.props.capturedBOData &&
                        this.props.capturedBOData.hasOwnProperty(
                    ...
                    onChange={
                      ...
                      this.props.capturedBOData.selectnicOption = selectNicOption.label
                    }}
                    required
                    />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('mainactivities')
                        ? this.props.capturedBOData.mainactivities
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('additionalactivities')
                        ? this.props.capturedBOData.additionalactivities
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedBOData.hasOwnProperty(
                          ...
                          ? this.props.capturedBOData.selectactivityOption
                    ...
                    onChange={selectActivityOption => {
                      ...
                      this.props.capturedBOData.selectactivityOption = selectActivityOption.label
                    }}
                    required
                    />
                  <AvFeedback>
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('buildingNo')
                        ? this.props.capturedBOData.buildingNo
                        : this.state.buildingNumber
                    }
                    onChange={e => {
                      this.setState({ buildingNumber: e.target.value})
                      this.props.capturedBOData.buildingNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('floorNo')
                        ? this.props.capturedBOData.floorNo
                        : this.state.floorNumber
                    }
                    onChange={e => {
                      this.setState({ floorNumber: e.target.value})
                      this.props.capturedBOData.floorNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('nameThePremisesOrBuilding')
                        ? this.props.capturedBOData.nameThePremisesOrBuilding
                        : this.state.nameOfThePremisesOrBuilding
                    }
                    onChange={e => {
                      this.setState({ nameOfThePremisesOrBuilding: e.target.value})
                      this.props.capturedBOData.nameOfThePremisesOrBuilding =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('Street')
                        ? this.props.capturedBOData.Street
                        : this.state.roadOrStreet
                    }
                    onChange={e => {
                      this.setState({ roadOrStreet: e.target.value})
                      this.props.capturedBOData.roadOrStreet =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('Area')
                        ? this.props.capturedBOData.Area
                        : this.state.area
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('City')
                        ? this.props.capturedBOData.City
                        : this.state.cityOrTownOrLocalityOrVillage
                    }
                    onChange={e => {
                      this.setState({ cityOrTownOrLocalityOrVillage: e.target.value})
                      this.props.capturedBOData.cityOrTownOrLocalityOrVillage =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('State')
                        ? this.props.capturedBOData.State
                        : this.state.state
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('Country')
                        ? this.props.capturedBOData.Country
                        : this.state.country
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('Pincode')
                        ? this.props.capturedBOData.Pincode
                        : this.state.pincode
                    }
                    onChange={e => {
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('officeemailAddress')
                        ? this.props.capturedBOData.officeemailAddress
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('mobileNo')
                        ? this.props.capturedBOData.mobileNo
                        : this.state.mobileNumber
                    }
                    onChange={e => {
                      this.setState({ mobileNumber: e.target.value})
                      this.props.capturedBOData.mobileNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('officeTelephoneNo')
                        ? this.props.capturedBOData.officeTelephoneNo
                        : this.state.officeTelephoneNumber
                    }
                    onChange={e => {
                      this.setState({ officeTelephoneNumber: e.target.value})
                      this.props.capturedBOData.officeTelephoneNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedBOData &&
                      this.props.capturedBOData.hasOwnProperty('officeFaxNo')
                        ? this.props.capturedBOData.officeFaxNo
