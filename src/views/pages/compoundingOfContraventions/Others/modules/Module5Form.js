...
class Module5Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedOthersData.panNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedOthersData.hasOwnProperty('nameOfPerson')
                        ? this.props.capturedOthersData.nameOfPerson
                        : this.state.nameOfThePerson
                    }
                    onChange={e => {
                      this.setState({ nameOfThePerson: e.target.value})
                      this.props.capturedOthersData.nameOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('addressOfPerson')
                        ? this.props.capturedOthersData.addressOfPerson
                        : this.state.addressOfThePerson
                    }
                    onChange={e => {
                      this.setState({ addressOfThePerson: e.target.value})
                      this.props.capturedOthersData.addressOfThePerson =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('designation')
                        ? this.props.capturedOthersData.designation
                        : this.state.designationOrStatus
                    }
                    onChange={e => {
                      this.setState({ designationOrStatus: e.target.value})
                      this.props.capturedOthersData.designationOrStatus =
                      e.target.value
                    }}
                    required
                  />
