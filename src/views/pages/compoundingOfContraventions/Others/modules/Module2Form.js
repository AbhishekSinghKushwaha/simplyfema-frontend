...
class Module2Form extends React.Component {
  ...
  componentWillReceiveProps(props){
    if(props.capturedOthersData && props.capturedOthersData.topicNameDescription){
    let questions = props.capturedOthersData.topicNameDescription
    this.setState({questions})
    }

    if(props.capturedOthersData && props.capturedOthersData.rbiReferenceLetter){
      let questions2 = props.capturedOthersData.rbiReferenceLetter
      this.setState({questions2})
      }

      if(props.capturedOthersData && props.capturedOthersData!== this.props.capturedOthersData && props.capturedOthersData.sampleOthers){
        let sampleOthers = props.capturedOthersData.sampleOthers
        this.setState({sampleOthers})
      }


      if(props.capturedOthersData && props.capturedOthersData!== this.props.capturedOthersData && props.capturedOthersData.sampleRbi){
        let sampleRbi = props.capturedOthersData.sampleRbi
  ...
  handleChange = (e) => {
    ...
    this.props.capturedOthersData.officeTeleNumber = e.target.value
  }
  ...
  handleText = i => e => {
    ...
    this.props.capturedOthersData.input1 = 
    this.state.input1
  }
  ...
  addInput = e => {
    //let questions = []
    //e.preventDefault()
    // if(this.props.capturedOthersData.topicNameDescription){
    //   questions = this.props.capturedOthersData.topicNameDescription.concat([...this.state.questions])
    //   }
    // else{
  ...
  this.props.capturedOthersData.rbiLetter = 
  ...
  addInput2 = (e) => {
    // e.preventDefault()
    // let questions2 = []
    // if(this.props.capturedOthersData.rbiReferenceLetter){
    //   questions2 = this.props.capturedOthersData.rbiReferenceLetter.concat([...this.state.questions2])
    //   }
    // else{
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedOthersData.hasOwnProperty('natureContravention')
                        ? this.props.capturedOthersData.natureContravention
                        : this.state.natureOfContravention
                    }
                    onChange={e => {
                      this.setState({ natureOfContravention: e.target.value})
                      this.props.capturedOthersData.natureOfContravention =
                      e.target.value
                    }}
                    required
                  />
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectFema
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectRegulationNo
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='input1'>Others - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedOthersData &&
          this.props.capturedOthersData.hasOwnProperty('topicNameDescription')
            ? this.props.capturedOthersData.topicNameDescription[index]
                  ...
                  <Checkbox
                    ...
                    onChange = {checkedValue => {
                      this.setState(prevState => {
                       ...
                       this.props.capturedOthersData.sampleOthers =
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectCAAoption
                          : CAAOptions[0].label,
                      value:
                        this.props.capturedOthersData &&
                        this.props.capturedOthersData.hasOwnProperty(
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectcentralOptions
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('subjectCompounding')
                        ? this.props.capturedOthersData.subjectCompounding
                        : this.state.subjectOfCompounding
                    }
                    onChange={e => {
                      this.setState({ subjectOfCompounding: e.target.value})
                      this.props.capturedOthersData.subjectOfCompounding =
                      e.target.value
                    }}
                    required
                  />
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    icon={<Check className='vx-icon' size={16} />}
                    label=''
                    checked={this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('sample_subjectOfCompounding_1')
                        ? this.props.capturedOthersData.sample_subjectOfCompounding_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('sample_subjectOfCompounding_2')
                        ? this.props.capturedOthersData.sample_subjectOfCompounding_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('sample_subjectOfCompounding_3')
                        ? this.props.capturedOthersData.sample_subjectOfCompounding_3
...
<Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>RBI Reference Letter - {index+1}</Label>
    ...
    <AvGroup  className='has-icon-left position-relative' style={{marginBottom:"10px"}}>
      ...
      <Input
        ...
        value={
          this.props.capturedOthersData &&
          this.props.capturedOthersData.hasOwnProperty('rbiReferenceLetter')
            ? this.props.capturedOthersData.rbiReferenceLetter[index]
            : this.state.rbiLetter[index]
        }
        //value={question}
        // onChange={e => {
        //   this.setState({ rbiReferenceLetter: e.target.value})
        //   this.props.capturedOthersData.rbiReferenceLetter =
        //   e.target.value
        // }}
        required
      />
                  ...
                  <Checkbox
                   ...
                   onChange = {checkedValue => {
                     ...
                     this.setState(prevState => {
                      ...
                      this.props.capturedOthersData.sampleRbi =
              ...
              <Col sm='10'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('residentoutsideIndia')
                        ? this.props.capturedOthersData.residentoutsideIndia
              ...
              <a href="#" className="popup__close">&times;</a>
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('sample_indiaOrNot_1')
                        ? this.props.capturedOthersData.sample_indiaOrNot_1
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('sample_indiaOrNot_2')
                        ? this.props.capturedOthersData.sample_indiaOrNot_2
                ...
                <dt>
                  ...
                  <Checkbox
                    ...
                    label=''
                    checked={this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('sample_indiaOrNot_3')
                        ? this.props.capturedOthersData.sample_indiaOrNot_3
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('nameAdjudicatingAuthority')
                        ? this.props.capturedOthersData.nameAdjudicatingAuthority
                        : this.state.nameOfAdjudicatingAuthority
                    }
                    onChange={e => {
                      this.setState({ nameOfAdjudicatingAuthority: e.target.value})
                      this.props.capturedOthersData.nameOfAdjudicatingAuthority =
                      e.target.value
                    }}
                    required
                  />
        ...
        <div style={{width:'25%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('compoundingApplicationfee')
                        ? this.props.capturedOthersData.compoundingApplicationfee
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedOthersData &&
                    //   this.props.capturedOthersData.hasOwnProperty('dateIncorporationmod2')
                    //     ? new Date(this.props.capturedOthersData.dateIncorporationmod2)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      ...
                      this.props.capturedOthersData.dateIncorporationmod2 = new Date(
        ...
        <div style={{width:'26%', paddingRight:'7px'}}>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('officeTeleNo')
                        ? this.props.capturedOthersData.officeTeleNo
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectpayOption
                          : PayOptions[0].label,
                      value:
                        this.props.capturedOthersData &&
                        this.props.capturedOthersData.hasOwnProperty(
