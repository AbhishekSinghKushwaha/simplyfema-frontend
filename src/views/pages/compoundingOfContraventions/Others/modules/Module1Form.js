...
class Module1Form extends React.Component {
  ...
  handleChange = (e) => {
    ...
    this.props.capturedOthersData.officeFaxNumber = e.target.value
  }
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedOthersData.hasOwnProperty('legalNameBusiness')
                        ? this.props.capturedOthersData.legalNameBusiness
                        : this.state.legalNameOfBusiness
                    }
                    onChange={e => {
                      this.setState({ legalNameOfBusiness: e.target.value})
                      this.props.capturedOthersData.legalNameOfBusiness =
                      e.target.value
                    }}
                    required
                    />
              ...
              <Label style={{paddingBottom:'13px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}}  for='nameVerticalIcons'>Date of Incorporation / Registration</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={ 
                    //   this.props.capturedOthersData &&
                    //   this.props.capturedOthersData.hasOwnProperty('dateIncorporation')
                    //     ? new Date(this.props.capturedOthersData.dateIncorporation)
                    //     : dateOfIncorporation
                    // }
                    onChange={enteredDate => {
                      this.setState({dateOfIncorporation:enteredDate})
                      this.props.capturedOthersData.dateIncorporation = new Date(
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('panNumber')
                        ? this.props.capturedOthersData.panNumber
              ...
              <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('cinNumber')
                        ? this.props.capturedOthersData.cinNumber
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectnicOption
                          : NicOptions[0].label,
                      value:
                        this.props.capturedOthersData &&
                        this.props.capturedOthersData.hasOwnProperty(
                    ...
                    onChange={
                      ...
                      this.props.capturedOthersData.selectnicOption = selectNicOption.label
                    }}
                    required
                    />
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('mainactivities')
                        ? this.props.capturedOthersData.mainactivities
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('additionalactivities')
                        ? this.props.capturedOthersData.additionalactivities
                ...
                <AvGroup style={{zIndex:"100"}} className='has-icon-left position-relative'>
                  <Select
                    ...
                    value={{
                      label:
                        ...
                        this.props.capturedOthersData.hasOwnProperty(
                          ...
                          ? this.props.capturedOthersData.selectactivityOption
                    ...
                    onChange={selectActivityOption => {
                      ...
                      this.props.capturedOthersData.selectactivityOption = selectActivityOption.label
                    }}
                    required
                    />
                  <AvFeedback>
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('buildingNo')
                        ? this.props.capturedOthersData.buildingNo
                        : this.state.buildingNumber
                    }
                    onChange={e => {
                      this.setState({ buildingNumber: e.target.value})
                      this.props.capturedOthersData.buildingNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('floorNo')
                        ? this.props.capturedOthersData.floorNo
                        : this.state.floorNumber
                    }
                    onChange={e => {
                      this.setState({ floorNumber: e.target.value})
                      this.props.capturedOthersData.floorNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('nameThePremisesOrBuilding')
                        ? this.props.capturedOthersData.nameThePremisesOrBuilding
                        : this.state.nameOfThePremisesOrBuilding
                    }
                    onChange={e => {
                      this.setState({ nameOfThePremisesOrBuilding: e.target.value})
                      this.props.capturedOthersData.nameOfThePremisesOrBuilding =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('Street')
                        ? this.props.capturedOthersData.Street
                        : this.state.roadOrStreet
                    }
                    onChange={e => {
                      this.setState({ roadOrStreet: e.target.value})
                      this.props.capturedOthersData.roadOrStreet =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('Area')
                        ? this.props.capturedOthersData.Area
                        : this.state.area
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('City')
                        ? this.props.capturedOthersData.City
                        : this.state.cityOrTownOrLocalityOrVillage
                    }
                    onChange={e => {
                      this.setState({ cityOrTownOrLocalityOrVillage: e.target.value})
                      this.props.capturedOthersData.cityOrTownOrLocalityOrVillage =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('State')
                        ? this.props.capturedOthersData.State
                        : this.state.state
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('Country')
                        ? this.props.capturedOthersData.Country
                        : this.state.country
                    }
                    onChange={e => {
        ...
        <Col sm='4'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('Pincode')
                        ? this.props.capturedOthersData.Pincode
                        : this.state.pincode
                    }
                    onChange={e => {
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('officeemailAddress')
                        ? this.props.capturedOthersData.officeemailAddress
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('mobileNo')
                        ? this.props.capturedOthersData.mobileNo
                        : this.state.mobileNumber
                    }
                    onChange={e => {
                      this.setState({ mobileNumber: e.target.value})
                      this.props.capturedOthersData.mobileNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('officeTelephoneNo')
                        ? this.props.capturedOthersData.officeTelephoneNo
                        : this.state.officeTelephoneNumber
                    }
                    onChange={e => {
                      this.setState({ officeTelephoneNumber: e.target.value})
                      this.props.capturedOthersData.officeTelephoneNumber =
                      e.target.value
                    }}
                    required
                    />
        ...
        <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('officeFaxNo')
                        ? this.props.capturedOthersData.officeFaxNo
