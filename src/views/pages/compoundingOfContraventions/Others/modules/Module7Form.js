...
handleChange = (e) => {
  ...
  this.setState({errors, [name]: value});
    ...
    this.props.capturedOthersData.incomeTaxPan = e.target.value
}
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      ...
                      this.props.capturedOthersData.hasOwnProperty('nameApplicant')
                        ? this.props.capturedOthersData.nameApplicant
                        : this.state.nameofApplicant
                    }
                    onChange={e => {
                      this.setState({ nameofApplicant: e.target.value})
                      this.props.capturedOthersData.nameofApplicant =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Label style={{paddingBottom:'9px' , color:'rgba(0 , 0  , 0 , 0.8)' , fontSize:'14px' , fontWeight:'500'}} for='nameVerticalIcons'>Date of incorporation</Label>
                <AvGroup className='has-icon-left position-relative'>
                  <Flatpickr
                    ...
                    // value={
                    //   this.props.capturedOthersData &&
                    //   this.props.capturedOthersData.hasOwnProperty('dateIncorporationfdi')
                    //     ? new Date(this.props.capturedOthersData.dateIncorporationfdi)
                    //     : dateOfIncorporation
                    // }
                    onChange={dateOfIncorporation => {
                      this.setState({ dateOfIncorporation})
                      this.props.capturedOthersData.dateIncorporationfdi =new Date(
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('incometaxPan')
                        ? this.props.capturedOthersData.incometaxPan
              ...
              <Col sm='6'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  ...
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('natureActivitiesUnderTakenNicCode')
                        ? this.props.capturedOthersData.natureActivitiesUnderTakenNicCode
                        : this.state.natureOfActivitiesUnderTakenNicCode
                    }
                    onChange={e => {
                      this.setState({ natureOfActivitiesUnderTakenNicCode: e.target.value})
                      this.props.capturedOthersData.natureOfActivitiesUnderTakenNicCode =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('briefParticularsAboutForeignInvestor')
                        ? this.props.capturedOthersData.briefParticularsAboutForeignInvestor
                        : this.state.briefParticularsAboutTheForeignInvestor
                    }
                    onChange={e => {
                      this.setState({ briefParticularsAboutTheForeignInvestor: e.target.value})
                      this.props.capturedOthersData.briefParticularsAboutTheForeignInvestor =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('detailsForeignInwardRemittancesRecievedByApplicantCompanyFromDateOfIncorporationTillDate')
                        ? this.props.capturedOthersData.detailsForeignInwardRemittancesRecievedByApplicantCompanyFromDateOfIncorporationTillDate
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedOthersData.detailsOfForrignInwardRemittancesRecievedByApplicantCompanyFromDateOfIncorporationTillDate =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('copiesBalanceSheetDuringThePeriodOfReceiptOfShareApplicationMoney')
                        ? this.props.capturedOthersData.copiesBalanceSheetDuringThePeriodOfReceiptOfShareApplicationMoney
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedOthersData.copiesOfBalanceSheetDuringThePeriodOfReceiptOfShareApplicationMoney =
                      e.target.value
                    }}
                    required
                  />
              ...
              <Col sm='12'>
                ...
                <AvGroup className='has-icon-left position-relative'>
                  <AvInput
                    ...
                    value={
                      this.props.capturedOthersData &&
                      this.props.capturedOthersData.hasOwnProperty('natureContraventionAndReasonsForTheContravention')
                        ? this.props.capturedOthersData.natureContraventionAndReasonsForTheContravention
                    ...
                    onChange={e => {
                      ...
                      this.props.capturedOthersData.natureOfContraventionAndReasonsForTheContravention =
                      e.target.value
                    }}
                    required
                  />
              ...
              <td style={{width: '5%' ,border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                <AvGroup  className=''>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('SlNoTA')
                                ? this.props.capturedOthersData.SlNoTA
                                : this.state.slNoTA
                            }
                            onChange={e => {
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TAnameRemitter')
                                ? this.props.capturedOthersData.TAnameRemitter
                                : this.state.TAnameOfRemitter
                            }
                            onChange={e => {
                              this.setState({ TAnameOfRemitter: e.target.value})
                              this.props.capturedOthersData.TAnameOfRemitter =
                              e.target.value
                            }}
                            required
                          />
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TAtotalamount')
                                ? this.props.capturedOthersData.TAtotalamount
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('dateReportingRbiTA')
                        //     ? new Date(this.props.capturedOthersData.dateReportingRbiTA)
                        //     : dateOfReportingRbiTA
                        // }
                        onChange={dateOfReportingRbiTA => {
                          this.setState({ dateOfReportingRbiTA})
                          this.props.capturedOthersData.dateReportingRbiTA =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('reportrbiTA')
                        //     ? new Date(this.props.capturedOthersData.reportrbiTA)
                        //     : reportRbiTA
                        // }
                        onChange={reportRbiTA => {
                          this.setState({ reportRbiTA})
                          this.props.capturedOthersData.reportrbiTA =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TAdelayifany')
                                ? this.props.capturedOthersData.TAdelayifany
                ...
                <AvGroup className='position-relative'>
                          <AvInput
                           disabled="true"
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TATotal')
                                ? this.props.capturedOthersData.TATotal
                                : this.state.TAtotal
                            }
                            onChange={e => {
              ...
              <tr>
                ...
                <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TBnameofInvestor')
                                ? this.props.capturedOthersData.TBnameofInvestor
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('dateAllotmentOfSharesTB')
                        //     ? new Date(this.props.capturedOthersData.dateAllotmentOfSharesTB)
                        //     : dateOfAllotmentOfSharesTB
                        // }
                        onChange={dateOfAllotmentOfSharesTB => {
                          this.setState({ dateOfAllotmentOfSharesTB})
                          this.props.capturedOthersData.dateAllotmentOfSharesTB =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TBnoSharesAlloted')
                                ? this.props.capturedOthersData.TBnoSharesAlloted
                                : this.state.TBnoOfSharesAlloted
                            }
                            onChange={e => {
                              this.setState({ TBnoOfSharesAlloted: e.target.value})
                              this.props.capturedOthersData.TBnoOfSharesAlloted =
                              e.target.value
                            }}
                            required
                          />
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TBamountWhichSharesAlloted')
                                ? this.props.capturedOthersData.TBamountWhichSharesAlloted
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('dateReportingRBITB')
                        //     ? new Date(this.props.capturedOthersData.dateReportingRBITB)
                        //     : dateOfReportingRBITB
                        // }
                        onChange={dateOfReportingRBITB => {
                          this.setState({ dateOfReportingRBITB})
                          this.props.capturedOthersData.dateReportingRBITB =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TBdelayifany')
                                ? this.props.capturedOthersData.TBdelayifany
                ...
                <AvGroup className='position-relative'>
                          <AvInput
                           disabled="true"
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TBTotal')
                                ? this.props.capturedOthersData.TBTotal
                                : this.state.TBtotal
                            }
                            onChange={e => {
              ...
              <td style={{width: '5%' ,border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                <AvGroup  className=''>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TCSlNo')
                                ? this.props.capturedOthersData.TCSlNo
                                : this.state.TCslNo
                            }
                            onChange={e => {
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TcnameRemitter')
                                ? this.props.capturedOthersData.TcnameRemitter
                                : this.state.TcnameOfRemitter
                            }
                            onChange={e => {
                              this.setState({ TcnameOfRemitter: e.target.value})
                              this.props.capturedOthersData.TcnameOfRemitter =
                              e.target.value
                            }}
                            required
                          />
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TCtotalamountINR')
                                ? this.props.capturedOthersData.TCtotalamountINR
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('dateRecieptTC')
                        //     ? new Date(this.props.capturedOthersData.dateRecieptTC)
                        //     : dateOfRecieptTC
                        // }
                        onChange={dateOfRecieptTC => {
                          this.setState({ dateOfRecieptTC})
                          this.props.capturedOthersData.dateRecieptTC =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TCExcessshareApplicationMoney')
                                ? this.props.capturedOthersData.TCExcessshareApplicationMoney
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('dateRefundTC')
                        //     ? new Date(this.props.capturedOthersData.dateRefundTC)
                        //     : dateOfRefundTC
                        // }
                        onChange={dateOfRefundTC => {
                          this.setState({ dateOfRefundTC})
                          this.props.capturedOthersData.dateRefundTC =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TCamountinForex')
                                ? this.props.capturedOthersData.TCamountinForex
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('rbiletterTC')
                        //     ? new Date(this.props.capturedOthersData.rbiletterTC)
                        //     : rbiLetterTC
                        // }
                        onChange={rbiLetterTC => {
                          this.setState({ rbiLetterTC})
                          this.props.capturedOthersData.rbiletterTC =new Date(
                ...
                <AvGroup className='position-relative'>
                          <AvInput
                           disabled="true"
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('TCTotal')
                                ? this.props.capturedOthersData.TCTotal
                                : this.props.TCtotal
                            }
                            id='TCtotal'
                            onChange={e => {
              ...
              <td style={{width: '5%' ,border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                <AvGroup  className=''>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('ACslNo')
                                ? this.props.capturedOthersData.ACslNo
                                : this.state.ACSlNo
                            }       
                            onChange={e => {
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('DateTI')
                        //     ? new Date(this.props.capturedOthersData.DateTI)
                        //     : dateTI
                        // }
                        onChange={dateTI => {
                          this.setState({ dateTI})
                          this.props.capturedOthersData.DateTI =new Date(
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('nameACenterAuthorizationCapital')
                                ? this.props.capturedOthersData.nameACenterAuthorizationCapital
                                : this.state.nameACenterAuthorizationZCapital
                            }
                            onChange={e => {
                              this.setState({ nameACenterAuthorizationZCapital: e.target.value})
                              this.props.capturedOthersData.nameACenterAuthorizationZCapital =
                              e.target.value
                            }}
                            required
                          />
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('ACEffectFrom')
                                ? this.props.capturedOthersData.ACEffectFrom
                                : this.state.ACwithEffectFrom
                            }
                            onChange={e => {
                              this.setState({ ACwithEffectFrom: e.target.value})
                              this.props.capturedOthersData.ACwithEffectFrom =
                              e.target.value
                            }}
                            required
                          />
                 ...
                 <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                          <AvInput
                            ...
                            value={
                              this.props.capturedOthersData &&
                              this.props.capturedOthersData.hasOwnProperty('ACdateBoardMeeting')
                                ? this.props.capturedOthersData.ACdateBoardMeeting
                                : this.state.ACdateOfBoardMeeting
                            }
                            onChange={e => {
                              this.setState({ ACdateOfBoardMeeting: e.target.value})
                              this.props.capturedOthersData.ACdateOfBoardMeeting =
                              e.target.value
                            }}
                            required
                          />
                ...
                <td style={{ border: '1px solid rgba(180 , 180 , 180 , 0.5)'}}>
                    <AvGroup className='has-icon-left position-relative'>
                      <Flatpickr
                        ...
                        // value={
                        //   this.props.capturedOthersData &&
                        //   this.props.capturedOthersData.hasOwnProperty('dateFillingROC')
                        //     ? new Date(this.props.capturedOthersData.dateFillingROC)
                        //     : dateOfFillingROC
                        // }
                        onChange={dateOfFillingROC => {
                          this.setState({ dateOfFillingROC})
                          this.props.capturedOthersData.dateFillingROC =new Date(
