              ...
              >
                <FormTag
                  ...
                  onSubmit={(e, errors, values) => {
                    ...
                    // var tempData = Object.assign(values, this.state.fetchedAPRData )
                    var tempData = Object.assign(
                      values,
                      this.props.capturedAPRData
                    )
                    Object.create(tempData)
                    this.setState({ fetchedAPRData: tempData })
                    this.props.nextData(this.state.fetchedAPRData)
...
VuexyWizard.propTypes = {
  ...
  APRData: PropTypes.array,
  nextData: PropTypes.func,
  capturedAPRData: PropTypes.object
}
