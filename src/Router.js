...
const Fdi = lazy(() => import("./views/pages/compoundingOfContraventions/FDI/module"))
const BO = lazy(() => import("./views/pages/compoundingOfContraventions/BO/module"))
const ECB = lazy(() => import("./views/pages/compoundingOfContraventions/ECB/module"))
const LO = lazy(() => import("./views/pages/compoundingOfContraventions/LO/module"))
const ODIAdi = lazy(() => import("./views/pages/compoundingOfContraventions/ODI/module"))
const PO = lazy(() => import("./views/pages/compoundingOfContraventions/PO/module"))
const COC = lazy(() => import("./views/pages/compoundingOfContraventions/COC/module"))
const Others = lazy(() => import("./views/pages/compoundingOfContraventions/Others/module"))

const Navbar = lazy(() => import("./components/reactstrap/navbar/Navbar"))
const Tabs = lazy(() => import("./components/reactstrap/tabs/Tabs"))
const DisInvestment = lazy(() => import("./views/pages/ODI/DisInvestment/module"))
const AnnualPerformanceReport = lazy(() => import("./views/pages/ODI/AnnualPerformanceReport/module"))
const ODI = lazy(() => import("./views/pages/ODI/OverseasDirectInvestments/module"))
...
const avatar = lazy(() => import("./components/Main/avatar/Avatar"))
const AutoComplete = lazy(() =>
  import("./components/Main/autoComplete/AutoComplete")
)
const chips = lazy(() => import("./components/Main/chips/Chips"))
const divider = lazy(() => import("./components/Main/divider/Divider"))
...
const pdfUploader = lazy(() => import("./views/pages/FileUpload/FileUpload"))
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/odi/odi" component={ODI} />
          <AppRoute path="/odi/disinvestment" component={DisInvestment} />
          <AppRoute path="/odi/annualperformancereport" component={AnnualPerformanceReport} />
         ...
         {/* Compounding of Contraventions Start */}

          <AppRoute path="/coc/fdi" component={Fdi} />
          <AppRoute path="/coc/bo" exact component={BO} />
          <AppRoute path="/coc/ecb" exact component={ECB} />
          <AppRoute path="/coc/lo" exact component={LO} />
          <AppRoute path="/coc/odi" exact component={ODIAdi} />
          <AppRoute path="/coc/po" exact component={PO} />
          <AppRoute path="/coc/coc" exact component={Fdi} />
          <AppRoute path="/coc/others" exact component={Others} />

          {/* Compounding of Contraventions End */}
          ...
          <AppRoute path="/pdf-uploader" component={pdfUploader} />
